...
export const WealthAnalyticsDashboard: React.FC = () => {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-black text-white tracking-tight">Institutional Wealth & Asset Allocation Dashboard</h1>
