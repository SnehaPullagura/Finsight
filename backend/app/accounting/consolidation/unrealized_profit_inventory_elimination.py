"""
Intercompany Inventory Margin Unrealized Profit Elimination
...
class UnrealizedProfitInventoryEliminationEntityNode(BaseModel):
    entity_code: str
    entity_name: str
...
class UnrealizedProfitInventoryEliminationConsolidationResult(BaseModel):
    consolidation_rule_name: str = "Intercompany Inventory Margin Unrealized Profit Elimination"
...
class UnrealizedProfitInventoryEliminationEngine:
    @classmethod
    def process_consolidation(
        cls, entities: List[UnrealizedProfitInventoryEliminationEntityNode]
    ) -> UnrealizedProfitInventoryEliminationConsolidationResult:
        ...
        return UnrealizedProfitInventoryEliminationConsolidationResult(
