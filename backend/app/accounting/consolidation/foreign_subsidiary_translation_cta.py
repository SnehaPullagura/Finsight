"""
Cumulative Translation Adjustment (CTA) under IAS 21
...
class ForeignSubsidiaryTranslationCtaEntityNode(BaseModel):
    entity_code: str
    entity_name: str
...
class ForeignSubsidiaryTranslationCtaConsolidationResult(BaseModel):
    consolidation_rule_name: str = "Cumulative Translation Adjustment (CTA) under IAS 21"
...
class ForeignSubsidiaryTranslationCtaEngine:
    @classmethod
    def process_consolidation(
        cls, entities: List[ForeignSubsidiaryTranslationCtaEntityNode]
    ) -> ForeignSubsidiaryTranslationCtaConsolidationResult:
        ...
        return ForeignSubsidiaryTranslationCtaConsolidationResult(
