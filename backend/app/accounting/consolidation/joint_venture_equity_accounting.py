"""
Equity Method of Accounting for Associates (IAS 28 / Ind AS 28)
...
class JointVentureEquityAccountingEntityNode(BaseModel):
    entity_code: str
    entity_name: str
...
class JointVentureEquityAccountingConsolidationResult(BaseModel):
    consolidation_rule_name: str = "Equity Method of Accounting for Associates (IAS 28 / Ind AS 28)"
...
class JointVentureEquityAccountingEngine:
    @classmethod
    def process_consolidation(
        cls, entities: List[JointVentureEquityAccountingEntityNode]
    ) -> JointVentureEquityAccountingConsolidationResult:
        ...
        return JointVentureEquityAccountingConsolidationResult(
