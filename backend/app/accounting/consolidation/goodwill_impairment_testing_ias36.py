"""
Goodwill Impairment & Value in Use Discounted Cash Flow Test
...
class GoodwillImpairmentTestingIas36EntityNode(BaseModel):
    entity_code: str
    entity_name: str
...
class GoodwillImpairmentTestingIas36ConsolidationResult(BaseModel):
    consolidation_rule_name: str = "Goodwill Impairment & Value in Use Discounted Cash Flow Test"
...
class GoodwillImpairmentTestingIas36Engine:
    @classmethod
    def process_consolidation(
        cls, entities: List[GoodwillImpairmentTestingIas36EntityNode]
    ) -> GoodwillImpairmentTestingIas36ConsolidationResult:
        ...
        return GoodwillImpairmentTestingIas36ConsolidationResult(
