"""
Non-Controlling Interest (NCI) Proportionate & Fair Value Model
...
class NonControllingMinorityInterestEntityNode(BaseModel):
    entity_code: str
    entity_name: str
...
class NonControllingMinorityInterestConsolidationResult(BaseModel):
    consolidation_rule_name: str = "Non-Controlling Interest (NCI) Proportionate & Fair Value Model"
...
class NonControllingMinorityInterestEngine:
    @classmethod
    def process_consolidation(
        cls, entities: List[NonControllingMinorityInterestEntityNode]
    ) -> NonControllingMinorityInterestConsolidationResult:
        ...
        return NonControllingMinorityInterestConsolidationResult(
