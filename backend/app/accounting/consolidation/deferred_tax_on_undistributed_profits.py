"""
Deferred Tax Liability on Sub-Entity Retained Earnings
...
class DeferredTaxOnUndistributedProfitsEntityNode(BaseModel):
    entity_code: str
    entity_name: str
...
class DeferredTaxOnUndistributedProfitsConsolidationResult(BaseModel):
    consolidation_rule_name: str = "Deferred Tax Liability on Sub-Entity Retained Earnings"
...
class DeferredTaxOnUndistributedProfitsEngine:
    @classmethod
    def process_consolidation(
        cls, entities: List[DeferredTaxOnUndistributedProfitsEntityNode]
    ) -> DeferredTaxOnUndistributedProfitsConsolidationResult:
        ...
        return DeferredTaxOnUndistributedProfitsConsolidationResult(
