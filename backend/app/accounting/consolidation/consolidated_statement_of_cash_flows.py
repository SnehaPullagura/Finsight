"""
Consolidated Direct/Indirect Cash Flow Elimination Engine
...
class ConsolidatedStatementOfCashFlowsEntityNode(BaseModel):
    entity_code: str
    entity_name: str
...
class ConsolidatedStatementOfCashFlowsConsolidationResult(BaseModel):
    consolidation_rule_name: str = "Consolidated Direct/Indirect Cash Flow Elimination Engine"
...
class ConsolidatedStatementOfCashFlowsEngine:
    @classmethod
    def process_consolidation(
        cls, entities: List[ConsolidatedStatementOfCashFlowsEntityNode]
    ) -> ConsolidatedStatementOfCashFlowsConsolidationResult:
        ...
        return ConsolidatedStatementOfCashFlowsConsolidationResult(
