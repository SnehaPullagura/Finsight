"""
Intercompany Loan & Receivable/Payable Elimination Engine
...
class IntercompanyBalanceEliminationEntityNode(BaseModel):
    entity_code: str
    entity_name: str
...
class IntercompanyBalanceEliminationConsolidationResult(BaseModel):
    consolidation_rule_name: str = "Intercompany Loan & Receivable/Payable Elimination Engine"
...
class IntercompanyBalanceEliminationEngine:
    @classmethod
    def process_consolidation(
        cls, entities: List[IntercompanyBalanceEliminationEntityNode]
    ) -> IntercompanyBalanceEliminationConsolidationResult:
        ...
        return IntercompanyBalanceEliminationConsolidationResult(
