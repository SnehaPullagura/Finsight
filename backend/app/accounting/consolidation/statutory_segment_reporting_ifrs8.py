"""
Operating Segments Aggregation & 10% Significance Thresholds
...
class StatutorySegmentReportingIfrs8EntityNode(BaseModel):
    entity_code: str
    entity_name: str
...
class StatutorySegmentReportingIfrs8ConsolidationResult(BaseModel):
    consolidation_rule_name: str = "Operating Segments Aggregation & 10% Significance Thresholds"
...
class StatutorySegmentReportingIfrs8Engine:
    @classmethod
    def process_consolidation(
        cls, entities: List[StatutorySegmentReportingIfrs8EntityNode]
    ) -> StatutorySegmentReportingIfrs8ConsolidationResult:
        ...
        return StatutorySegmentReportingIfrs8ConsolidationResult(
