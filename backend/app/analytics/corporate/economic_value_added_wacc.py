"""
Economic Value Added (EVA) and Weighted Average Cost of Capital
...
class EconomicValueAddedWaccInputs(BaseModel):
...
class EconomicValueAddedWaccMetricDetail(BaseModel):
    metric_code: str
    metric_name: str
...
class EconomicValueAddedWaccEvaluationResult(BaseModel):
    model_name: str = "Economic Value Added (EVA) and Weighted Average Cost of Capital"
    ...
    key_metrics: List[EconomicValueAddedWaccMetricDetail]
    strategic_recommendations: List[str]

class EconomicValueAddedWaccEngine:
    @classmethod
    def evaluate(cls, inp: EconomicValueAddedWaccInputs) -> EconomicValueAddedWaccEvaluationResult:
        ...
        metrics = [
            EconomicValueAddedWaccMetricDetail(
                metric_code="EBITDA",
        ...
        return EconomicValueAddedWaccEvaluationResult(
