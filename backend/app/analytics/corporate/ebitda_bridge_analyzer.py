"""
EBITDA Bridge & Operating Margin Variance Decomposer
...
class EbitdaBridgeAnalyzerInputs(BaseModel):
...
class EbitdaBridgeAnalyzerMetricDetail(BaseModel):
    metric_code: str
    metric_name: str
...
class EbitdaBridgeAnalyzerEvaluationResult(BaseModel):
    model_name: str = "EBITDA Bridge & Operating Margin Variance Decomposer"
    ...
    key_metrics: List[EbitdaBridgeAnalyzerMetricDetail]
    strategic_recommendations: List[str]

class EbitdaBridgeAnalyzerEngine:
    @classmethod
    def evaluate(cls, inp: EbitdaBridgeAnalyzerInputs) -> EbitdaBridgeAnalyzerEvaluationResult:
        ...
        metrics = [
            EbitdaBridgeAnalyzerMetricDetail(
                metric_code="EBITDA",
        ...
        return EbitdaBridgeAnalyzerEvaluationResult(
