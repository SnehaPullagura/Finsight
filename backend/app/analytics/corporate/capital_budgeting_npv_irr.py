"""
Capital Budgeting: NPV, IRR, MIRR, PI and Payback Periods
...
class CapitalBudgetingNpvIrrInputs(BaseModel):
...
class CapitalBudgetingNpvIrrMetricDetail(BaseModel):
    metric_code: str
    metric_name: str
...
class CapitalBudgetingNpvIrrEvaluationResult(BaseModel):
    model_name: str = "Capital Budgeting: NPV, IRR, MIRR, PI and Payback Periods"
    ...
    key_metrics: List[CapitalBudgetingNpvIrrMetricDetail]
    strategic_recommendations: List[str]

class CapitalBudgetingNpvIrrEngine:
    @classmethod
    def evaluate(cls, inp: CapitalBudgetingNpvIrrInputs) -> CapitalBudgetingNpvIrrEvaluationResult:
        ...
        metrics = [
            CapitalBudgetingNpvIrrMetricDetail(
                metric_code="EBITDA",
        ...
        return CapitalBudgetingNpvIrrEvaluationResult(
