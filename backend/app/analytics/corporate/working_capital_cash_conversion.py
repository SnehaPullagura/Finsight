"""
Cash Conversion Cycle (CCC): DIO, DSO, and DPO Analysis
...
class WorkingCapitalCashConversionInputs(BaseModel):
...
class WorkingCapitalCashConversionMetricDetail(BaseModel):
    metric_code: str
    metric_name: str
...
class WorkingCapitalCashConversionEvaluationResult(BaseModel):
    model_name: str = "Cash Conversion Cycle (CCC): DIO, DSO, and DPO Analysis"
    ...
    key_metrics: List[WorkingCapitalCashConversionMetricDetail]
    strategic_recommendations: List[str]

class WorkingCapitalCashConversionEngine:
    @classmethod
    def evaluate(cls, inp: WorkingCapitalCashConversionInputs) -> WorkingCapitalCashConversionEvaluationResult:
        ...
        metrics = [
            WorkingCapitalCashConversionMetricDetail(
                metric_code="EBITDA",
        ...
        return WorkingCapitalCashConversionEvaluationResult(
