"""
Beneish 8-Variable M-Score Financial Manipulation Detector
...
class BeneishMScoreEarningsManipulationInputs(BaseModel):
...
class BeneishMScoreEarningsManipulationMetricDetail(BaseModel):
    metric_code: str
    metric_name: str
...
class BeneishMScoreEarningsManipulationEvaluationResult(BaseModel):
    model_name: str = "Beneish 8-Variable M-Score Financial Manipulation Detector"
    ...
    key_metrics: List[BeneishMScoreEarningsManipulationMetricDetail]
    strategic_recommendations: List[str]

class BeneishMScoreEarningsManipulationEngine:
    @classmethod
    def evaluate(cls, inp: BeneishMScoreEarningsManipulationInputs) -> BeneishMScoreEarningsManipulationEvaluationResult:
        ...
        metrics = [
            BeneishMScoreEarningsManipulationMetricDetail(
                metric_code="EBITDA",
        ...
        return BeneishMScoreEarningsManipulationEvaluationResult(
