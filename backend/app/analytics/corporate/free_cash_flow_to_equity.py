"""
Free Cash Flow to Firm (FCFF) & Equity (FCFE) Engine
...
class FreeCashFlowToEquityInputs(BaseModel):
...
class FreeCashFlowToEquityMetricDetail(BaseModel):
    metric_code: str
    metric_name: str
...
class FreeCashFlowToEquityEvaluationResult(BaseModel):
    model_name: str = "Free Cash Flow to Firm (FCFF) & Equity (FCFE) Engine"
    ...
    key_metrics: List[FreeCashFlowToEquityMetricDetail]
    strategic_recommendations: List[str]

class FreeCashFlowToEquityEngine:
    @classmethod
    def evaluate(cls, inp: FreeCashFlowToEquityInputs) -> FreeCashFlowToEquityEvaluationResult:
        ...
        metrics = [
            FreeCashFlowToEquityMetricDetail(
                metric_code="EBITDA",
        ...
        return FreeCashFlowToEquityEvaluationResult(
