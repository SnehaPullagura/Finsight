"""
Two-Stage & Three-Stage Discounted Cash Flow (DCF) Valuation
...
class DiscountedCashFlowTwoStageInputs(BaseModel):
...
class DiscountedCashFlowTwoStageMetricDetail(BaseModel):
    metric_code: str
    metric_name: str
...
class DiscountedCashFlowTwoStageEvaluationResult(BaseModel):
    model_name: str = "Two-Stage & Three-Stage Discounted Cash Flow (DCF) Valuation"
    ...
    key_metrics: List[DiscountedCashFlowTwoStageMetricDetail]
    strategic_recommendations: List[str]

class DiscountedCashFlowTwoStageEngine:
    @classmethod
    def evaluate(cls, inp: DiscountedCashFlowTwoStageInputs) -> DiscountedCashFlowTwoStageEvaluationResult:
        ...
        metrics = [
            DiscountedCashFlowTwoStageMetricDetail(
                metric_code="EBITDA",
        ...
        return DiscountedCashFlowTwoStageEvaluationResult(
