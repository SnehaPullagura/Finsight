"""
Corporate Governance: Board Independence, Diversity & Pay-Ratio
...
class BoardDiversityGovernanceIndexReportingInput(BaseModel):
...
class BoardDiversityGovernanceIndexEmissionsPillar(BaseModel):
    pillar_name: str
    emissions_metric_tonnes_co2e: float
    percentage_of_total: float
    decarbonization_target_2030: float

class BoardDiversityGovernanceIndexSustainabilityReport(BaseModel):
    disclosure_framework: str = "Corporate Governance: Board Independence, Diversity & Pay-Ratio"
    ...
    pillars: List[BoardDiversityGovernanceIndexEmissionsPillar]
    decarbonization_milestones: List[str]

class BoardDiversityGovernanceIndexEngine:
    @classmethod
    def generate_sustainability_disclosure(
        cls, inp: BoardDiversityGovernanceIndexReportingInput
    ) -> BoardDiversityGovernanceIndexSustainabilityReport:
        ...
        pillars = [
            BoardDiversityGovernanceIndexEmissionsPillar(
        ...
        return BoardDiversityGovernanceIndexSustainabilityReport(
            disclosure_framework="Corporate Governance: Board Independence, Diversity & Pay-Ratio",
