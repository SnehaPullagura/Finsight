...
class BrsrCoreSebiComplianceMatrixReportingInput(BaseModel):
...
class BrsrCoreSebiComplianceMatrixEmissionsPillar(BaseModel):
    pillar_name: str
    emissions_metric_tonnes_co2e: float
    percentage_of_total: float
    decarbonization_target_2030: float

class BrsrCoreSebiComplianceMatrixSustainabilityReport(BaseModel):
    disclosure_framework: str = "SEBI Business Responsibility and Sustainability Reporting (BRSR)"
    ...
    pillars: List[BrsrCoreSebiComplianceMatrixEmissionsPillar]
    decarbonization_milestones: List[str]

class BrsrCoreSebiComplianceMatrixEngine:
    @classmethod
    def generate_sustainability_disclosure(
        cls, inp: BrsrCoreSebiComplianceMatrixReportingInput
    ) -> BrsrCoreSebiComplianceMatrixSustainabilityReport:
        ...
        pillars = [
            BrsrCoreSebiComplianceMatrixEmissionsPillar(
        ...
        return BrsrCoreSebiComplianceMatrixSustainabilityReport(
            disclosure_framework="SEBI Business Responsibility and Sustainability Reporting (BRSR)",
