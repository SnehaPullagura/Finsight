"""
Supplier Sustainability Scorecard & Code of Conduct Verification
...
class SustainableProcurementSupplierAuditReportingInput(BaseModel):
...
class SustainableProcurementSupplierAuditEmissionsPillar(BaseModel):
    pillar_name: str
    emissions_metric_tonnes_co2e: float
    percentage_of_total: float
    decarbonization_target_2030: float

class SustainableProcurementSupplierAuditSustainabilityReport(BaseModel):
    disclosure_framework: str = "Supplier Sustainability Scorecard & Code of Conduct Verification"
    ...
    pillars: List[SustainableProcurementSupplierAuditEmissionsPillar]
    decarbonization_milestones: List[str]

class SustainableProcurementSupplierAuditEngine:
    @classmethod
    def generate_sustainability_disclosure(
        cls, inp: SustainableProcurementSupplierAuditReportingInput
    ) -> SustainableProcurementSupplierAuditSustainabilityReport:
        ...
        pillars = [
            SustainableProcurementSupplierAuditEmissionsPillar(
        ...
        return SustainableProcurementSupplierAuditSustainabilityReport(
            disclosure_framework="Supplier Sustainability Scorecard & Code of Conduct Verification",
