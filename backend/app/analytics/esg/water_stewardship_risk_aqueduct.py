"""
WRI Aqueduct Water Basin Stress Risk & Consumption Intensity Index
...
class WaterStewardshipRiskAqueductReportingInput(BaseModel):
...
class WaterStewardshipRiskAqueductEmissionsPillar(BaseModel):
    pillar_name: str
    emissions_metric_tonnes_co2e: float
    percentage_of_total: float
    decarbonization_target_2030: float

class WaterStewardshipRiskAqueductSustainabilityReport(BaseModel):
    disclosure_framework: str = "WRI Aqueduct Water Basin Stress Risk & Consumption Intensity Index"
    ...
    pillars: List[WaterStewardshipRiskAqueductEmissionsPillar]
    decarbonization_milestones: List[str]

class WaterStewardshipRiskAqueductEngine:
    @classmethod
    def generate_sustainability_disclosure(
        cls, inp: WaterStewardshipRiskAqueductReportingInput
    ) -> WaterStewardshipRiskAqueductSustainabilityReport:
        ...
        pillars = [
            WaterStewardshipRiskAqueductEmissionsPillar(
        ...
        return WaterStewardshipRiskAqueductSustainabilityReport(
            disclosure_framework="WRI Aqueduct Water Basin Stress Risk & Consumption Intensity Index",
