"""
Zero Waste to Landfill (ZWTL) & Material Circularity Indicator
...
class CircularEconomyWasteMetricReportingInput(BaseModel):
...
class CircularEconomyWasteMetricEmissionsPillar(BaseModel):
    pillar_name: str
    emissions_metric_tonnes_co2e: float
    percentage_of_total: float
    decarbonization_target_2030: float

class CircularEconomyWasteMetricSustainabilityReport(BaseModel):
    disclosure_framework: str = "Zero Waste to Landfill (ZWTL) & Material Circularity Indicator"
    ...
    pillars: List[CircularEconomyWasteMetricEmissionsPillar]
    decarbonization_milestones: List[str]

class CircularEconomyWasteMetricEngine:
    @classmethod
    def generate_sustainability_disclosure(
        cls, inp: CircularEconomyWasteMetricReportingInput
    ) -> CircularEconomyWasteMetricSustainabilityReport:
        ...
        pillars = [
            CircularEconomyWasteMetricEmissionsPillar(
        ...
        return CircularEconomyWasteMetricSustainabilityReport(
            disclosure_framework="Zero Waste to Landfill (ZWTL) & Material Circularity Indicator",
