"""
Dark Pool Liquidity Seeker & Midpoint Pegged Crossing Engine
...
class DarkPoolLiquidityCrossEngineParentOrder(BaseModel):
...
class DarkPoolLiquidityCrossEngineChildSlice(BaseModel):
    slice_index: int
    execution_time: str
    venue_name: str
...
class DarkPoolLiquidityCrossEngineExecutionReport(BaseModel):
    algorithm_name: str = "Dark Pool Liquidity Seeker & Midpoint Pegged Crossing Engine"
    ...
    child_slices: List[DarkPoolLiquidityCrossEngineChildSlice]
    tca_summary_notes: List[str]

class DarkPoolLiquidityCrossEngineEngine:
    @classmethod
    def execute_routing(
        cls, order: DarkPoolLiquidityCrossEngineParentOrder
    ) -> DarkPoolLiquidityCrossEngineExecutionReport:
        slices = []
        n_slices = 8
        ...
        for i in range(1, n_slices + 1):
            ...
            slices.append(DarkPoolLiquidityCrossEngineChildSlice(
                slice_index=i,
                execution_time=ts,
                venue_name=venue,
        ...
        return DarkPoolLiquidityCrossEngineExecutionReport(
