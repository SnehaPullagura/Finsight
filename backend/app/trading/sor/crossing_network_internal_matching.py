"""
Crossing Network Internal Matching & Internalization Savings
...
class CrossingNetworkInternalMatchingParentOrder(BaseModel):
...
class CrossingNetworkInternalMatchingChildSlice(BaseModel):
    slice_index: int
    execution_time: str
    venue_name: str
...
class CrossingNetworkInternalMatchingExecutionReport(BaseModel):
    algorithm_name: str = "Crossing Network Internal Matching & Internalization Savings"
    ...
    child_slices: List[CrossingNetworkInternalMatchingChildSlice]
    tca_summary_notes: List[str]

class CrossingNetworkInternalMatchingEngine:
    @classmethod
    def execute_routing(
        cls, order: CrossingNetworkInternalMatchingParentOrder
    ) -> CrossingNetworkInternalMatchingExecutionReport:
        slices = []
        n_slices = 8
        ...
        for i in range(1, n_slices + 1):
            ...
            slices.append(CrossingNetworkInternalMatchingChildSlice(
                slice_index=i,
                execution_time=ts,
                venue_name=venue,
        ...
        return CrossingNetworkInternalMatchingExecutionReport(
