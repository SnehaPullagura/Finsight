"""
Percentage of Volume (POV) Dynamic Real-Time Rate Adaptation
...
class PovPercentageOfVolumeEngineParentOrder(BaseModel):
...
class PovPercentageOfVolumeEngineChildSlice(BaseModel):
    slice_index: int
    execution_time: str
    venue_name: str
...
class PovPercentageOfVolumeEngineExecutionReport(BaseModel):
    algorithm_name: str = "Percentage of Volume (POV) Dynamic Real-Time Rate Adaptation"
    ...
    child_slices: List[PovPercentageOfVolumeEngineChildSlice]
    tca_summary_notes: List[str]

class PovPercentageOfVolumeEngineEngine:
    @classmethod
    def execute_routing(
        cls, order: PovPercentageOfVolumeEngineParentOrder
    ) -> PovPercentageOfVolumeEngineExecutionReport:
        slices = []
        n_slices = 8
        ...
        for i in range(1, n_slices + 1):
            ...
            slices.append(PovPercentageOfVolumeEngineChildSlice(
                slice_index=i,
                execution_time=ts,
                venue_name=venue,
        ...
        return PovPercentageOfVolumeEngineExecutionReport(
