"""
Guaranteed VWAP Agency Order Slicing & Volume Participation
...
class GuaranteedVwapAgencyExecutionParentOrder(BaseModel):
...
class GuaranteedVwapAgencyExecutionChildSlice(BaseModel):
    slice_index: int
    execution_time: str
    venue_name: str
...
class GuaranteedVwapAgencyExecutionExecutionReport(BaseModel):
    algorithm_name: str = "Guaranteed VWAP Agency Order Slicing & Volume Participation"
    ...
    child_slices: List[GuaranteedVwapAgencyExecutionChildSlice]
    tca_summary_notes: List[str]

class GuaranteedVwapAgencyExecutionEngine:
    @classmethod
    def execute_routing(
        cls, order: GuaranteedVwapAgencyExecutionParentOrder
    ) -> GuaranteedVwapAgencyExecutionExecutionReport:
        slices = []
        n_slices = 8
        ...
        for i in range(1, n_slices + 1):
            ...
            slices.append(GuaranteedVwapAgencyExecutionChildSlice(
                slice_index=i,
                execution_time=ts,
                venue_name=venue,
        ...
        return GuaranteedVwapAgencyExecutionExecutionReport(
