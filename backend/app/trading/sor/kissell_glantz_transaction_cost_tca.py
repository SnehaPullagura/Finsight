"""
Kissell-Glantz Pre-Trade and Post-Trade Transaction Cost Analysis
...
class KissellGlantzTransactionCostTcaParentOrder(BaseModel):
...
class KissellGlantzTransactionCostTcaChildSlice(BaseModel):
    slice_index: int
    execution_time: str
    venue_name: str
...
class KissellGlantzTransactionCostTcaExecutionReport(BaseModel):
    algorithm_name: str = "Kissell-Glantz Pre-Trade and Post-Trade Transaction Cost Analysis"
    ...
    child_slices: List[KissellGlantzTransactionCostTcaChildSlice]
    tca_summary_notes: List[str]

class KissellGlantzTransactionCostTcaEngine:
    @classmethod
    def execute_routing(
        cls, order: KissellGlantzTransactionCostTcaParentOrder
    ) -> KissellGlantzTransactionCostTcaExecutionReport:
        slices = []
        n_slices = 8
        ...
        for i in range(1, n_slices + 1):
            ...
            slices.append(KissellGlantzTransactionCostTcaChildSlice(
                slice_index=i,
                execution_time=ts,
                venue_name=venue,
        ...
        return KissellGlantzTransactionCostTcaExecutionReport(
