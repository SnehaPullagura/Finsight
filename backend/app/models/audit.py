...
class AuditLog(UUIDModel, TenantMixin):
    ...
    action: Mapped[str] = mapped_column(String(50), nullable=False, index=True) # CREATE, UPDATE, DELETE, STAGE_CHANGE, LOGIN, EXPORT
    entity_type: Mapped[str] = mapped_column(String(50), nullable=False, index=True) # contact, company, lead, deal, ticket, etc.
