"""
Comprehensive Assets vs Liabilities Net Worth Calculator
...
class NetWorthCalculatorInputs(BaseModel):
...
class NetWorthCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class NetWorthCalculatorResult(BaseModel):
    calculator_name: str = "Comprehensive Assets vs Liabilities Net Worth Calculator"
    ...
    yearly_schedule: List[NetWorthCalculatorYearBreakdown]

class NetWorthCalculatorEngine:
    @classmethod
    def calculate(cls, inp: NetWorthCalculatorInputs) -> NetWorthCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(NetWorthCalculatorYearBreakdown(
                year_number=yr,
        ...
        return NetWorthCalculatorResult(
