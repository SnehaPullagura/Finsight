"""
Compound Annual Growth Rate (CAGR) and Absolute Return Calculator
...
class CagrCalculatorInputs(BaseModel):
...
class CagrCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class CagrCalculatorResult(BaseModel):
    calculator_name: str = "Compound Annual Growth Rate (CAGR) and Absolute Return Calculator"
    ...
    yearly_schedule: List[CagrCalculatorYearBreakdown]

class CagrCalculatorEngine:
    @classmethod
    def calculate(cls, inp: CagrCalculatorInputs) -> CagrCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(CagrCalculatorYearBreakdown(
                year_number=yr,
