"""
Public Provident Fund (PPF) 15-Year Compound Interest Calculator
...
class PpfCalculatorInputs(BaseModel):
...
class PpfCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class PpfCalculatorResult(BaseModel):
    calculator_name: str = "Public Provident Fund (PPF) 15-Year Compound Interest Calculator"
    ...
    yearly_schedule: List[PpfCalculatorYearBreakdown]

class PpfCalculatorEngine:
    @classmethod
    def calculate(cls, inp: PpfCalculatorInputs) -> PpfCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(PpfCalculatorYearBreakdown(
                year_number=yr,
