"""
Gratuity Payment Calculator (Payment of Gratuity Act 1972)
...
class GratuityCalculatorInputs(BaseModel):
...
class GratuityCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class GratuityCalculatorResult(BaseModel):
    calculator_name: str = "Gratuity Payment Calculator (Payment of Gratuity Act 1972)"
    ...
    yearly_schedule: List[GratuityCalculatorYearBreakdown]

class GratuityCalculatorEngine:
    @classmethod
    def calculate(cls, inp: GratuityCalculatorInputs) -> GratuityCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(GratuityCalculatorYearBreakdown(
                year_number=yr,
        ...
        return GratuityCalculatorResult(
