"""
Dividend Yield and Reinvestment (DRIP) Compounding Calculator
...
class DividendYieldCalculatorInputs(BaseModel):
...
class DividendYieldCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class DividendYieldCalculatorResult(BaseModel):
    calculator_name: str = "Dividend Yield and Reinvestment (DRIP) Compounding Calculator"
    ...
    yearly_schedule: List[DividendYieldCalculatorYearBreakdown]

class DividendYieldCalculatorEngine:
    @classmethod
    def calculate(cls, inp: DividendYieldCalculatorInputs) -> DividendYieldCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(DividendYieldCalculatorYearBreakdown(
                year_number=yr,
        ...
        return DividendYieldCalculatorResult(
