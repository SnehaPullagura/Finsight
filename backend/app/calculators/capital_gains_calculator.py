"""
Long-Term & Short-Term Capital Gains (LTCG / STCG) Tax Calculator
...
class CapitalGainsCalculatorInputs(BaseModel):
...
class CapitalGainsCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class CapitalGainsCalculatorResult(BaseModel):
    calculator_name: str = "Long-Term & Short-Term Capital Gains (LTCG / STCG) Tax Calculator"
    ...
    yearly_schedule: List[CapitalGainsCalculatorYearBreakdown]

class CapitalGainsCalculatorEngine:
    @classmethod
    def calculate(cls, inp: CapitalGainsCalculatorInputs) -> CapitalGainsCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(CapitalGainsCalculatorYearBreakdown(
                year_number=yr,
        ...
        return CapitalGainsCalculatorResult(
