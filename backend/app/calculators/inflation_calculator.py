"""
Purchasing Power Decay and Real Rate of Return Calculator
...
class InflationCalculatorInputs(BaseModel):
...
class InflationCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class InflationCalculatorResult(BaseModel):
    calculator_name: str = "Purchasing Power Decay and Real Rate of Return Calculator"
    ...
    yearly_schedule: List[InflationCalculatorYearBreakdown]

class InflationCalculatorEngine:
    @classmethod
    def calculate(cls, inp: InflationCalculatorInputs) -> InflationCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(InflationCalculatorYearBreakdown(
                year_number=yr,
        ...
        return InflationCalculatorResult(
