"""
Fixed Deposit (FD) and Recurring Deposit (RD) Quarterly Compounding Calculator
...
class FdCalculatorInputs(BaseModel):
...
class FdCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class FdCalculatorResult(BaseModel):
    calculator_name: str = "Fixed Deposit (FD) and Recurring Deposit (RD) Quarterly Compounding Calculator"
    ...
    yearly_schedule: List[FdCalculatorYearBreakdown]

class FdCalculatorEngine:
    @classmethod
    def calculate(cls, inp: FdCalculatorInputs) -> FdCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(FdCalculatorYearBreakdown(
                year_number=yr,
