"""
National Pension System (NPS) Tier I & Tier II Annuity Calculator
...
class NpsCalculatorInputs(BaseModel):
...
class NpsCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class NpsCalculatorResult(BaseModel):
    calculator_name: str = "National Pension System (NPS) Tier I & Tier II Annuity Calculator"
    ...
    yearly_schedule: List[NpsCalculatorYearBreakdown]

class NpsCalculatorEngine:
    @classmethod
    def calculate(cls, inp: NpsCalculatorInputs) -> NpsCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(NpsCalculatorYearBreakdown(
                year_number=yr,
