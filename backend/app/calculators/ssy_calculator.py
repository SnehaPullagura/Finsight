"""
Sukanya Samriddhi Yojana (SSY) Sovereign Girl Child Savings Calculator
...
class SsyCalculatorInputs(BaseModel):
...
class SsyCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class SsyCalculatorResult(BaseModel):
    calculator_name: str = "Sukanya Samriddhi Yojana (SSY) Sovereign Girl Child Savings Calculator"
    ...
    yearly_schedule: List[SsyCalculatorYearBreakdown]

class SsyCalculatorEngine:
    @classmethod
    def calculate(cls, inp: SsyCalculatorInputs) -> SsyCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(SsyCalculatorYearBreakdown(
                year_number=yr,
