"""
Liquid Emergency Reserve Sufficiency Calculator
...
class EmergencyFundCalculatorInputs(BaseModel):
...
class EmergencyFundCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class EmergencyFundCalculatorResult(BaseModel):
    calculator_name: str = "Liquid Emergency Reserve Sufficiency Calculator"
    ...
    yearly_schedule: List[EmergencyFundCalculatorYearBreakdown]

class EmergencyFundCalculatorEngine:
    @classmethod
    def calculate(cls, inp: EmergencyFundCalculatorInputs) -> EmergencyFundCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(EmergencyFundCalculatorYearBreakdown(
                year_number=yr,
        ...
        return EmergencyFundCalculatorResult(
