"""
House Rent Allowance (HRA) Exemption Calculator under Section 10(13A)
...
class HraCalculatorInputs(BaseModel):
...
class HraCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class HraCalculatorResult(BaseModel):
    calculator_name: str = "House Rent Allowance (HRA) Exemption Calculator under Section 10(13A)"
    ...
    yearly_schedule: List[HraCalculatorYearBreakdown]

class HraCalculatorEngine:
    @classmethod
    def calculate(cls, inp: HraCalculatorInputs) -> HraCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(HraCalculatorYearBreakdown(
                year_number=yr,
