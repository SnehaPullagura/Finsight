"""
Systematic Withdrawal Plan (SWP) Capital Preservation Calculator
...
class SwpCalculatorInputs(BaseModel):
...
class SwpCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class SwpCalculatorResult(BaseModel):
    calculator_name: str = "Systematic Withdrawal Plan (SWP) Capital Preservation Calculator"
    ...
    yearly_schedule: List[SwpCalculatorYearBreakdown]

class SwpCalculatorEngine:
    @classmethod
    def calculate(cls, inp: SwpCalculatorInputs) -> SwpCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(SwpCalculatorYearBreakdown(
                year_number=yr,
