"""
Trading Margin and Leverage Risk Calculator
...
class MarginCalculatorInputs(BaseModel):
...
class MarginCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class MarginCalculatorResult(BaseModel):
    calculator_name: str = "Trading Margin and Leverage Risk Calculator"
    ...
    yearly_schedule: List[MarginCalculatorYearBreakdown]

class MarginCalculatorEngine:
    @classmethod
    def calculate(cls, inp: MarginCalculatorInputs) -> MarginCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(MarginCalculatorYearBreakdown(
                year_number=yr,
