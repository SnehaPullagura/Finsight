"""
Financial Independence Retire Early (FIRE) Multiplier Calculator
...
class FireCalculatorInputs(BaseModel):
...
class FireCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class FireCalculatorResult(BaseModel):
    calculator_name: str = "Financial Independence Retire Early (FIRE) Multiplier Calculator"
    ...
    yearly_schedule: List[FireCalculatorYearBreakdown]

class FireCalculatorEngine:
    @classmethod
    def calculate(cls, inp: FireCalculatorInputs) -> FireCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(FireCalculatorYearBreakdown(
                year_number=yr,
