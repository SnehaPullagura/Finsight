"""
Equated Monthly Installment (EMI) and Prepayment Schedule Calculator
...
class EmiCalculatorInputs(BaseModel):
...
class EmiCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class EmiCalculatorResult(BaseModel):
    calculator_name: str = "Equated Monthly Installment (EMI) and Prepayment Schedule Calculator"
    ...
    yearly_schedule: List[EmiCalculatorYearBreakdown]

class EmiCalculatorEngine:
    @classmethod
    def calculate(cls, inp: EmiCalculatorInputs) -> EmiCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(EmiCalculatorYearBreakdown(
                year_number=yr,
