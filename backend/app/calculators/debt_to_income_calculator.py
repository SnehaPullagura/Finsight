"""
Debt-to-Income (DTI) and Debt Service Coverage Ratio (DSCR) Calculator
...
class DebtToIncomeCalculatorInputs(BaseModel):
...
class DebtToIncomeCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class DebtToIncomeCalculatorResult(BaseModel):
    calculator_name: str = "Debt-to-Income (DTI) and Debt Service Coverage Ratio (DSCR) Calculator"
    ...
    yearly_schedule: List[DebtToIncomeCalculatorYearBreakdown]

class DebtToIncomeCalculatorEngine:
    @classmethod
    def calculate(cls, inp: DebtToIncomeCalculatorInputs) -> DebtToIncomeCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(DebtToIncomeCalculatorYearBreakdown(
                year_number=yr,
        ...
        return DebtToIncomeCalculatorResult(
