"""
Systematic Investment Plan (SIP) and Step-Up SIP Compounding Calculator
...
class SipCalculatorInputs(BaseModel):
...
class SipCalculatorYearBreakdown(BaseModel):
    year_number: int
...
class SipCalculatorResult(BaseModel):
    calculator_name: str = "Systematic Investment Plan (SIP) and Step-Up SIP Compounding Calculator"
    ...
    yearly_schedule: List[SipCalculatorYearBreakdown]

class SipCalculatorEngine:
    @classmethod
    def calculate(cls, inp: SipCalculatorInputs) -> SipCalculatorResult:
        ...
        for yr in range(1, years + 1):
            ...
            yearly.append(SipCalculatorYearBreakdown(
                year_number=yr,
