"""
Moody's KMV Expected Default Frequency (EDF) Mapping Engine
...
class KmvExpectedDefaultFrequencyBorrowerProfile(BaseModel):
...
class KmvExpectedDefaultFrequencyRiskRating(BaseModel):
    model_name: str = "Moody's KMV Expected Default Frequency (EDF) Mapping Engine"
    borrower_id: str
...
class KmvExpectedDefaultFrequencyEngine:
    @classmethod
    def evaluate_credit_risk(cls, b: KmvExpectedDefaultFrequencyBorrowerProfile) -> KmvExpectedDefaultFrequencyRiskRating:
        ...
        return KmvExpectedDefaultFrequencyRiskRating(
