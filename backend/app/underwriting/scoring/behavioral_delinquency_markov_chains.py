"""
Markov Transition Matrix for 30/60/90+ DPD Roll Rates
...
class BehavioralDelinquencyMarkovChainsBorrowerProfile(BaseModel):
...
class BehavioralDelinquencyMarkovChainsRiskRating(BaseModel):
    model_name: str = "Markov Transition Matrix for 30/60/90+ DPD Roll Rates"
    borrower_id: str
...
class BehavioralDelinquencyMarkovChainsEngine:
    @classmethod
    def evaluate_credit_risk(cls, b: BehavioralDelinquencyMarkovChainsBorrowerProfile) -> BehavioralDelinquencyMarkovChainsRiskRating:
        ...
        return BehavioralDelinquencyMarkovChainsRiskRating(
