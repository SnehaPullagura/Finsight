"""
Merton Structural Distance-to-Default & Option-Theoretic Risk
...
class MertonStructuralCreditModelBorrowerProfile(BaseModel):
...
class MertonStructuralCreditModelRiskRating(BaseModel):
    model_name: str = "Merton Structural Distance-to-Default & Option-Theoretic Risk"
    borrower_id: str
...
class MertonStructuralCreditModelEngine:
    @classmethod
    def evaluate_credit_risk(cls, b: MertonStructuralCreditModelBorrowerProfile) -> MertonStructuralCreditModelRiskRating:
        ...
        return MertonStructuralCreditModelRiskRating(
