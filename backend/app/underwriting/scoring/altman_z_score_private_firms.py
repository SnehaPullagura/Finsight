"""
Altman Z'' Score for Private Manufacturing & Non-Manufacturing
...
class AltmanZScorePrivateFirmsBorrowerProfile(BaseModel):
...
class AltmanZScorePrivateFirmsRiskRating(BaseModel):
    model_name: str = "Altman Z'' Score for Private Manufacturing & Non-Manufacturing"
    borrower_id: str
...
class AltmanZScorePrivateFirmsEngine:
    @classmethod
    def evaluate_credit_risk(cls, b: AltmanZScorePrivateFirmsBorrowerProfile) -> AltmanZScorePrivateFirmsRiskRating:
        ...
        return AltmanZScorePrivateFirmsRiskRating(
