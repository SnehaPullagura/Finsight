"""
Collateral Recovery Rate & Fire-Sale Liquidation Haircut
...
class CollateralHaircutLiquidationPricerBorrowerProfile(BaseModel):
...
class CollateralHaircutLiquidationPricerRiskRating(BaseModel):
    model_name: str = "Collateral Recovery Rate & Fire-Sale Liquidation Haircut"
    borrower_id: str
...
class CollateralHaircutLiquidationPricerEngine:
    @classmethod
    def evaluate_credit_risk(cls, b: CollateralHaircutLiquidationPricerBorrowerProfile) -> CollateralHaircutLiquidationPricerRiskRating:
        ...
        return CollateralHaircutLiquidationPricerRiskRating(
