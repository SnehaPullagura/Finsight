"""
State-Space Model & Kalman Filter Time-Varying Beta Estimator
...
class TimeVaryingBetaStateSpaceKfOptimizationInput(BaseModel):
...
class TimeVaryingBetaStateSpaceKfAllocatedAsset(BaseModel):
    asset_id: str
    optimal_allocation_weight_pct: float
    marginal_risk_contribution_pct: float
    expected_annual_return_pct: float

class TimeVaryingBetaStateSpaceKfOptimizationResult(BaseModel):
    algorithm_title: str = "State-Space Model & Kalman Filter Time-Varying Beta Estimator"
    ...
    optimal_weights: List[TimeVaryingBetaStateSpaceKfAllocatedAsset]
    mathematical_convergence_notes: List[str]

class TimeVaryingBetaStateSpaceKfEngine:
    @classmethod
    def run_optimization(
        cls, inp: TimeVaryingBetaStateSpaceKfOptimizationInput
    ) -> TimeVaryingBetaStateSpaceKfOptimizationResult:
        ...
        for i in range(n):
            ...
            allocated_items.append(TimeVaryingBetaStateSpaceKfAllocatedAsset(
        ...
        return TimeVaryingBetaStateSpaceKfOptimizationResult(
