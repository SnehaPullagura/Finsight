"""
Euler Risk Decomposition & Equal Risk Contribution (ERC) Engine
...
class RiskBudgetingEqualRiskContribOptimizationInput(BaseModel):
...
class RiskBudgetingEqualRiskContribAllocatedAsset(BaseModel):
    asset_id: str
    optimal_allocation_weight_pct: float
    marginal_risk_contribution_pct: float
    expected_annual_return_pct: float

class RiskBudgetingEqualRiskContribOptimizationResult(BaseModel):
    algorithm_title: str = "Euler Risk Decomposition & Equal Risk Contribution (ERC) Engine"
    ...
    optimal_weights: List[RiskBudgetingEqualRiskContribAllocatedAsset]
    mathematical_convergence_notes: List[str]

class RiskBudgetingEqualRiskContribEngine:
    @classmethod
    def run_optimization(
        cls, inp: RiskBudgetingEqualRiskContribOptimizationInput
    ) -> RiskBudgetingEqualRiskContribOptimizationResult:
        ...
        for i in range(n):
            ...
            allocated_items.append(RiskBudgetingEqualRiskContribAllocatedAsset(
        ...
        return RiskBudgetingEqualRiskContribOptimizationResult(
