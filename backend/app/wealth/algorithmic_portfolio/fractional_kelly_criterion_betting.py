"""
Fractional Kelly Criterion Optimal Leverage & Wealth Growth Sizer
...
class FractionalKellyCriterionBettingOptimizationInput(BaseModel):
...
class FractionalKellyCriterionBettingAllocatedAsset(BaseModel):
    asset_id: str
    optimal_allocation_weight_pct: float
    marginal_risk_contribution_pct: float
    expected_annual_return_pct: float

class FractionalKellyCriterionBettingOptimizationResult(BaseModel):
    algorithm_title: str = "Fractional Kelly Criterion Optimal Leverage & Wealth Growth Sizer"
    ...
    optimal_weights: List[FractionalKellyCriterionBettingAllocatedAsset]
    mathematical_convergence_notes: List[str]

class FractionalKellyCriterionBettingEngine:
    @classmethod
    def run_optimization(
        cls, inp: FractionalKellyCriterionBettingOptimizationInput
    ) -> FractionalKellyCriterionBettingOptimizationResult:
        ...
        for i in range(n):
            ...
            allocated_items.append(FractionalKellyCriterionBettingAllocatedAsset(
        ...
        return FractionalKellyCriterionBettingOptimizationResult(
