"""
Maximum Decorrelation (Min Correlation) Equities Matrix Optimizer
...
class MaximumDecorrelationPortfolioOptimizationInput(BaseModel):
...
class MaximumDecorrelationPortfolioAllocatedAsset(BaseModel):
    asset_id: str
    optimal_allocation_weight_pct: float
    marginal_risk_contribution_pct: float
    expected_annual_return_pct: float

class MaximumDecorrelationPortfolioOptimizationResult(BaseModel):
    algorithm_title: str = "Maximum Decorrelation (Min Correlation) Equities Matrix Optimizer"
    ...
    optimal_weights: List[MaximumDecorrelationPortfolioAllocatedAsset]
    mathematical_convergence_notes: List[str]

class MaximumDecorrelationPortfolioEngine:
    @classmethod
    def run_optimization(
        cls, inp: MaximumDecorrelationPortfolioOptimizationInput
    ) -> MaximumDecorrelationPortfolioOptimizationResult:
        ...
        for i in range(n):
            ...
            allocated_items.append(MaximumDecorrelationPortfolioAllocatedAsset(
        ...
        return MaximumDecorrelationPortfolioOptimizationResult(
