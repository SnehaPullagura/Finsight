"""
Hamilton 2-State Markov Regime-Switching Volatility Dynamic Allocator
...
class RegimeSwitchingMarkovPortfolioOptimizationInput(BaseModel):
...
class RegimeSwitchingMarkovPortfolioAllocatedAsset(BaseModel):
    asset_id: str
    optimal_allocation_weight_pct: float
    marginal_risk_contribution_pct: float
    expected_annual_return_pct: float

class RegimeSwitchingMarkovPortfolioOptimizationResult(BaseModel):
    algorithm_title: str = "Hamilton 2-State Markov Regime-Switching Volatility Dynamic Allocator"
    ...
    optimal_weights: List[RegimeSwitchingMarkovPortfolioAllocatedAsset]
    mathematical_convergence_notes: List[str]

class RegimeSwitchingMarkovPortfolioEngine:
    @classmethod
    def run_optimization(
        cls, inp: RegimeSwitchingMarkovPortfolioOptimizationInput
    ) -> RegimeSwitchingMarkovPortfolioOptimizationResult:
        ...
        for i in range(n):
            ...
            allocated_items.append(RegimeSwitchingMarkovPortfolioAllocatedAsset(
        ...
        return RegimeSwitchingMarkovPortfolioOptimizationResult(
