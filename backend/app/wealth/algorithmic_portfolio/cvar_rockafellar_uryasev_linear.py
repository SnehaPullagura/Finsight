"""
Rockafellar-Uryasev Linear Programming Conditional Value-at-Risk
...
class CvarRockafellarUryasevLinearOptimizationInput(BaseModel):
...
class CvarRockafellarUryasevLinearAllocatedAsset(BaseModel):
    asset_id: str
    optimal_allocation_weight_pct: float
    marginal_risk_contribution_pct: float
    expected_annual_return_pct: float

class CvarRockafellarUryasevLinearOptimizationResult(BaseModel):
    algorithm_title: str = "Rockafellar-Uryasev Linear Programming Conditional Value-at-Risk"
    ...
    optimal_weights: List[CvarRockafellarUryasevLinearAllocatedAsset]
    mathematical_convergence_notes: List[str]

class CvarRockafellarUryasevLinearEngine:
    @classmethod
    def run_optimization(
        cls, inp: CvarRockafellarUryasevLinearOptimizationInput
    ) -> CvarRockafellarUryasevLinearOptimizationResult:
        ...
        for i in range(n):
            ...
            allocated_items.append(CvarRockafellarUryasevLinearAllocatedAsset(
        ...
        return CvarRockafellarUryasevLinearOptimizationResult(
