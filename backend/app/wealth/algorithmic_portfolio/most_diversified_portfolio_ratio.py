"""
Choueifaty Diversification Ratio (DR) Maximization Engine
...
class MostDiversifiedPortfolioRatioOptimizationInput(BaseModel):
...
class MostDiversifiedPortfolioRatioAllocatedAsset(BaseModel):
    asset_id: str
    optimal_allocation_weight_pct: float
    marginal_risk_contribution_pct: float
    expected_annual_return_pct: float

class MostDiversifiedPortfolioRatioOptimizationResult(BaseModel):
    algorithm_title: str = "Choueifaty Diversification Ratio (DR) Maximization Engine"
    ...
    optimal_weights: List[MostDiversifiedPortfolioRatioAllocatedAsset]
    mathematical_convergence_notes: List[str]

class MostDiversifiedPortfolioRatioEngine:
    @classmethod
    def run_optimization(
        cls, inp: MostDiversifiedPortfolioRatioOptimizationInput
    ) -> MostDiversifiedPortfolioRatioOptimizationResult:
        ...
        for i in range(n):
            ...
            allocated_items.append(MostDiversifiedPortfolioRatioAllocatedAsset(
        ...
        return MostDiversifiedPortfolioRatioOptimizationResult(
