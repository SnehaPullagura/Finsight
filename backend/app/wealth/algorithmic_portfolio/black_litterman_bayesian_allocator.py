"""
Black-Litterman Bayesian Asset Allocation with Subjective Views Matrix
...
class BlackLittermanBayesianAllocatorOptimizationInput(BaseModel):
...
class BlackLittermanBayesianAllocatorAllocatedAsset(BaseModel):
    asset_id: str
    optimal_allocation_weight_pct: float
    marginal_risk_contribution_pct: float
    expected_annual_return_pct: float

class BlackLittermanBayesianAllocatorOptimizationResult(BaseModel):
    algorithm_title: str = "Black-Litterman Bayesian Asset Allocation with Subjective Views Matrix"
    ...
    optimal_weights: List[BlackLittermanBayesianAllocatorAllocatedAsset]
    mathematical_convergence_notes: List[str]

class BlackLittermanBayesianAllocatorEngine:
    @classmethod
    def run_optimization(
        cls, inp: BlackLittermanBayesianAllocatorOptimizationInput
    ) -> BlackLittermanBayesianAllocatorOptimizationResult:
        ...
        for i in range(n):
            ...
            allocated_items.append(BlackLittermanBayesianAllocatorAllocatedAsset(
        ...
        return BlackLittermanBayesianAllocatorOptimizationResult(
