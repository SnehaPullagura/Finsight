"""
Downside Risk Mean-Semivariance (Sortino) Optimization Engine
...
class MeanSemivarianceDownsideOptimizerOptimizationInput(BaseModel):
...
class MeanSemivarianceDownsideOptimizerAllocatedAsset(BaseModel):
    asset_id: str
    optimal_allocation_weight_pct: float
    marginal_risk_contribution_pct: float
    expected_annual_return_pct: float

class MeanSemivarianceDownsideOptimizerOptimizationResult(BaseModel):
    algorithm_title: str = "Downside Risk Mean-Semivariance (Sortino) Optimization Engine"
    ...
    optimal_weights: List[MeanSemivarianceDownsideOptimizerAllocatedAsset]
    mathematical_convergence_notes: List[str]

class MeanSemivarianceDownsideOptimizerEngine:
    @classmethod
    def run_optimization(
        cls, inp: MeanSemivarianceDownsideOptimizerOptimizationInput
    ) -> MeanSemivarianceDownsideOptimizerOptimizationResult:
        ...
        for i in range(n):
            ...
            allocated_items.append(MeanSemivarianceDownsideOptimizerAllocatedAsset(
        ...
        return MeanSemivarianceDownsideOptimizerOptimizationResult(
