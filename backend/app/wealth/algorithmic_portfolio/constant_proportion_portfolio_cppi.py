"""
CPPI Floor & Cushion Dynamic Asset Allocation Strategy
...
class ConstantProportionPortfolioCppiOptimizationInput(BaseModel):
...
class ConstantProportionPortfolioCppiAllocatedAsset(BaseModel):
    asset_id: str
    optimal_allocation_weight_pct: float
    marginal_risk_contribution_pct: float
    expected_annual_return_pct: float

class ConstantProportionPortfolioCppiOptimizationResult(BaseModel):
    algorithm_title: str = "CPPI Floor & Cushion Dynamic Asset Allocation Strategy"
    ...
    optimal_weights: List[ConstantProportionPortfolioCppiAllocatedAsset]
    mathematical_convergence_notes: List[str]

class ConstantProportionPortfolioCppiEngine:
    @classmethod
    def run_optimization(
        cls, inp: ConstantProportionPortfolioCppiOptimizationInput
    ) -> ConstantProportionPortfolioCppiOptimizationResult:
        ...
        for i in range(n):
            ...
            allocated_items.append(ConstantProportionPortfolioCppiAllocatedAsset(
        ...
        return ConstantProportionPortfolioCppiOptimizationResult(
