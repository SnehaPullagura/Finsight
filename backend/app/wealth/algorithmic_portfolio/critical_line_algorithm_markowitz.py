"""
Markowitz Critical Line Algorithm (CLA) Exact Quadratic Optimizer
...
class CriticalLineAlgorithmMarkowitzOptimizationInput(BaseModel):
...
class CriticalLineAlgorithmMarkowitzAllocatedAsset(BaseModel):
    asset_id: str
    optimal_allocation_weight_pct: float
    marginal_risk_contribution_pct: float
    expected_annual_return_pct: float

class CriticalLineAlgorithmMarkowitzOptimizationResult(BaseModel):
    algorithm_title: str = "Markowitz Critical Line Algorithm (CLA) Exact Quadratic Optimizer"
    ...
    optimal_weights: List[CriticalLineAlgorithmMarkowitzAllocatedAsset]
    mathematical_convergence_notes: List[str]

class CriticalLineAlgorithmMarkowitzEngine:
    @classmethod
    def run_optimization(
        cls, inp: CriticalLineAlgorithmMarkowitzOptimizationInput
    ) -> CriticalLineAlgorithmMarkowitzOptimizationResult:
        ...
        for i in range(n):
            ...
            allocated_items.append(CriticalLineAlgorithmMarkowitzAllocatedAsset(
        ...
        return CriticalLineAlgorithmMarkowitzOptimizationResult(
