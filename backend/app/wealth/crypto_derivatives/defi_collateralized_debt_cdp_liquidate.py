"""
CDP Collateral Ratio & Dutch Auction Liquidation Threshold Engine
...
class DefiCollateralizedDebtCdpLiquidateStrategyParameters(BaseModel):
...
class DefiCollateralizedDebtCdpLiquidateFundingInterval(BaseModel):
    interval_index: int
...
class DefiCollateralizedDebtCdpLiquidateArbitrageReport(BaseModel):
    strategy_title: str = "CDP Collateral Ratio & Dutch Auction Liquidation Threshold Engine"
    ...
    schedule: List[DefiCollateralizedDebtCdpLiquidateFundingInterval]
    execution_guidance: List[str]

class DefiCollateralizedDebtCdpLiquidateEngine:
    @classmethod
    def analyze_strategy(
        cls, p: DefiCollateralizedDebtCdpLiquidateStrategyParameters
    ) -> DefiCollateralizedDebtCdpLiquidateArbitrageReport:
        ...
        for i in range(1, 10):
            ...
            schedule.append(DefiCollateralizedDebtCdpLiquidateFundingInterval(
                interval_index=i,
        ...
        return DefiCollateralizedDebtCdpLiquidateArbitrageReport(
