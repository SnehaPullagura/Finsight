"""
Deribit Crypto Options Volatility Skew & Smile SVI Parameterization
...
class CryptoOptionsDeribitImpliedVolStrategyParameters(BaseModel):
...
class CryptoOptionsDeribitImpliedVolFundingInterval(BaseModel):
    interval_index: int
...
class CryptoOptionsDeribitImpliedVolArbitrageReport(BaseModel):
    strategy_title: str = "Deribit Crypto Options Volatility Skew & Smile SVI Parameterization"
    ...
    schedule: List[CryptoOptionsDeribitImpliedVolFundingInterval]
    execution_guidance: List[str]

class CryptoOptionsDeribitImpliedVolEngine:
    @classmethod
    def analyze_strategy(
        cls, p: CryptoOptionsDeribitImpliedVolStrategyParameters
    ) -> CryptoOptionsDeribitImpliedVolArbitrageReport:
        ...
        for i in range(1, 10):
            ...
            schedule.append(CryptoOptionsDeribitImpliedVolFundingInterval(
                interval_index=i,
        ...
        return CryptoOptionsDeribitImpliedVolArbitrageReport(
