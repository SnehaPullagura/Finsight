"""
Perpetual Contract Funding Rate Arbitrage & Spot-Futures Basis
...
class PerpetualFundingRateArbitrageStrategyParameters(BaseModel):
...
class PerpetualFundingRateArbitrageFundingInterval(BaseModel):
    interval_index: int
...
class PerpetualFundingRateArbitrageArbitrageReport(BaseModel):
    strategy_title: str = "Perpetual Contract Funding Rate Arbitrage & Spot-Futures Basis"
    ...
    schedule: List[PerpetualFundingRateArbitrageFundingInterval]
    execution_guidance: List[str]

class PerpetualFundingRateArbitrageEngine:
    @classmethod
    def analyze_strategy(
        cls, p: PerpetualFundingRateArbitrageStrategyParameters
    ) -> PerpetualFundingRateArbitrageArbitrageReport:
        ...
        for i in range(1, 10):
            ...
            schedule.append(PerpetualFundingRateArbitrageFundingInterval(
                interval_index=i,
        ...
        return PerpetualFundingRateArbitrageArbitrageReport(
