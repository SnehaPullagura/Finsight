"""
PNGRB Gas Transmission Zonal Pipeline Capacity Tariff Engine
...
class GasPipelinePipelineCapacityTariffsAssetTelemetry(BaseModel):
...
class GasPipelinePipelineCapacityTariffsDistributionQuarter(BaseModel):
    quarter_label: str
...
class GasPipelinePipelineCapacityTariffsValuationReport(BaseModel):
    asset_name: str = "PNGRB Gas Transmission Zonal Pipeline Capacity Tariff Engine"
    ...
    quarterly_distribution_schedule: List[GasPipelinePipelineCapacityTariffsDistributionQuarter]
    regulatory_compliance_check: List[str]

class GasPipelinePipelineCapacityTariffsEngine:
    @classmethod
    def evaluate_asset_cash_flow(
        cls, a: GasPipelinePipelineCapacityTariffsAssetTelemetry
    ) -> GasPipelinePipelineCapacityTariffsValuationReport:
        ...
        quarters: List[GasPipelinePipelineCapacityTariffsDistributionQuarter] = []
        q_dpu = annual_dpu / 4.0

        for q in range(1, 5):
            quarters.append(GasPipelinePipelineCapacityTariffsDistributionQuarter(
        ...
        return GasPipelinePipelineCapacityTariffsValuationReport(
