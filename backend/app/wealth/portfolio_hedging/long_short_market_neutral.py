"""
Statistical Pairs Long/Short Market Neutral Equities Engine
...
class LongShortMarketNeutralParams(BaseModel):
...
class LongShortMarketNeutralContractRequirement(BaseModel):
    contract_symbol: str
...
class LongShortMarketNeutralResult(BaseModel):
    strategy_title: str = "Statistical Pairs Long/Short Market Neutral Equities Engine"
    unhedged_portfolio_value: float
    hedge_recommendation: LongShortMarketNeutralContractRequirement
    downside_protection_scenarios: Dict[str, float]
    implementation_notes: List[str]

class LongShortMarketNeutralEngine:
    @classmethod
    def calculate_hedge(cls, p: LongShortMarketNeutralParams) -> LongShortMarketNeutralResult:
        ...
        contract_req = LongShortMarketNeutralContractRequirement(
        ...
        return LongShortMarketNeutralResult(
