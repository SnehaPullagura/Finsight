"""
Corporate Credit Spread & Sovereign CDS Risk Mitigation
...
class CreditDefaultSpreadHedgingParams(BaseModel):
...
class CreditDefaultSpreadHedgingContractRequirement(BaseModel):
    contract_symbol: str
...
class CreditDefaultSpreadHedgingResult(BaseModel):
    strategy_title: str = "Corporate Credit Spread & Sovereign CDS Risk Mitigation"
    unhedged_portfolio_value: float
    hedge_recommendation: CreditDefaultSpreadHedgingContractRequirement
    downside_protection_scenarios: Dict[str, float]
    implementation_notes: List[str]

class CreditDefaultSpreadHedgingEngine:
    @classmethod
    def calculate_hedge(cls, p: CreditDefaultSpreadHedgingParams) -> CreditDefaultSpreadHedgingResult:
        ...
        contract_req = CreditDefaultSpreadHedgingContractRequirement(
        ...
        return CreditDefaultSpreadHedgingResult(
