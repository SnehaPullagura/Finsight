"""
Convertible Bond Delta-Neutral Gamma Scalping Engine
...
class ConvertibleBondArbitrageParams(BaseModel):
...
class ConvertibleBondArbitrageContractRequirement(BaseModel):
    contract_symbol: str
...
class ConvertibleBondArbitrageResult(BaseModel):
    strategy_title: str = "Convertible Bond Delta-Neutral Gamma Scalping Engine"
    unhedged_portfolio_value: float
    hedge_recommendation: ConvertibleBondArbitrageContractRequirement
    downside_protection_scenarios: Dict[str, float]
    implementation_notes: List[str]

class ConvertibleBondArbitrageEngine:
    @classmethod
    def calculate_hedge(cls, p: ConvertibleBondArbitrageParams) -> ConvertibleBondArbitrageResult:
        ...
        contract_req = ConvertibleBondArbitrageContractRequirement(
        ...
        return ConvertibleBondArbitrageResult(
