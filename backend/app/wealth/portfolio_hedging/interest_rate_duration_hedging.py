"""
Interest Rate Swap (IRS) & Bond Duration Matching
...
class InterestRateDurationHedgingParams(BaseModel):
...
class InterestRateDurationHedgingContractRequirement(BaseModel):
    contract_symbol: str
...
class InterestRateDurationHedgingResult(BaseModel):
    strategy_title: str = "Interest Rate Swap (IRS) & Bond Duration Matching"
    unhedged_portfolio_value: float
    hedge_recommendation: InterestRateDurationHedgingContractRequirement
    downside_protection_scenarios: Dict[str, float]
    implementation_notes: List[str]

class InterestRateDurationHedgingEngine:
    @classmethod
    def calculate_hedge(cls, p: InterestRateDurationHedgingParams) -> InterestRateDurationHedgingResult:
        ...
        contract_req = InterestRateDurationHedgingContractRequirement(
        ...
        return InterestRateDurationHedgingResult(
