"""
Black Swan Tail Risk Deep OTM Put Option Overlay Engine
...
class TailRiskPutOptionsOverlayParams(BaseModel):
...
class TailRiskPutOptionsOverlayContractRequirement(BaseModel):
    contract_symbol: str
...
class TailRiskPutOptionsOverlayResult(BaseModel):
    strategy_title: str = "Black Swan Tail Risk Deep OTM Put Option Overlay Engine"
    unhedged_portfolio_value: float
    hedge_recommendation: TailRiskPutOptionsOverlayContractRequirement
    downside_protection_scenarios: Dict[str, float]
    implementation_notes: List[str]

class TailRiskPutOptionsOverlayEngine:
    @classmethod
    def calculate_hedge(cls, p: TailRiskPutOptionsOverlayParams) -> TailRiskPutOptionsOverlayResult:
        ...
        contract_req = TailRiskPutOptionsOverlayContractRequirement(
        ...
        return TailRiskPutOptionsOverlayResult(
