"""
Durable Power of Attorney & Living Will Health Directive Engine
...
class PowerOfAttorneyMedicalDurableTrustStructure(BaseModel):
...
class PowerOfAttorneyMedicalDurableBeneficiaryShare(BaseModel):
    beneficiary_id: str
    relationship: str
...
class PowerOfAttorneyMedicalDurableEstatePlanResult(BaseModel):
    structure_title: str = "Durable Power of Attorney & Living Will Health Directive Engine"
    ...
    beneficiary_allocations: List[PowerOfAttorneyMedicalDurableBeneficiaryShare]
    statutory_governance_clauses: List[str]

class PowerOfAttorneyMedicalDurableEngine:
    @classmethod
    def generate_estate_structure(
        cls, t: PowerOfAttorneyMedicalDurableTrustStructure
    ) -> PowerOfAttorneyMedicalDurableEstatePlanResult:
        ...
        for i in range(1, t.beneficiaries_count + 1):
            shares.append(PowerOfAttorneyMedicalDurableBeneficiaryShare(
        ...
        return PowerOfAttorneyMedicalDurableEstatePlanResult(
