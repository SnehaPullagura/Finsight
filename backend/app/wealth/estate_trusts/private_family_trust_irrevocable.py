"""
Private Family Trust (Irrevocable Discretionary) Asset Protection
...
class PrivateFamilyTrustIrrevocableTrustStructure(BaseModel):
...
class PrivateFamilyTrustIrrevocableBeneficiaryShare(BaseModel):
    beneficiary_id: str
    relationship: str
...
class PrivateFamilyTrustIrrevocableEstatePlanResult(BaseModel):
    structure_title: str = "Private Family Trust (Irrevocable Discretionary) Asset Protection"
    ...
    beneficiary_allocations: List[PrivateFamilyTrustIrrevocableBeneficiaryShare]
    statutory_governance_clauses: List[str]

class PrivateFamilyTrustIrrevocableEngine:
    @classmethod
    def generate_estate_structure(
        cls, t: PrivateFamilyTrustIrrevocableTrustStructure
    ) -> PrivateFamilyTrustIrrevocableEstatePlanResult:
        ...
        for i in range(1, t.beneficiaries_count + 1):
            shares.append(PrivateFamilyTrustIrrevocableBeneficiaryShare(
        ...
        return PrivateFamilyTrustIrrevocableEstatePlanResult(
