"""
Offshore Trust FATCA / CRS Foreign Asset Disclosure Matrix
...
class CrossBorderOffshoreTrustFatcaTrustStructure(BaseModel):
...
class CrossBorderOffshoreTrustFatcaBeneficiaryShare(BaseModel):
    beneficiary_id: str
    relationship: str
...
class CrossBorderOffshoreTrustFatcaEstatePlanResult(BaseModel):
    structure_title: str = "Offshore Trust FATCA / CRS Foreign Asset Disclosure Matrix"
    ...
    beneficiary_allocations: List[CrossBorderOffshoreTrustFatcaBeneficiaryShare]
    statutory_governance_clauses: List[str]

class CrossBorderOffshoreTrustFatcaEngine:
    @classmethod
    def generate_estate_structure(
        cls, t: CrossBorderOffshoreTrustFatcaTrustStructure
    ) -> CrossBorderOffshoreTrustFatcaEstatePlanResult:
        ...
        for i in range(1, t.beneficiaries_count + 1):
            shares.append(CrossBorderOffshoreTrustFatcaBeneficiaryShare(
        ...
        return CrossBorderOffshoreTrustFatcaEstatePlanResult(
