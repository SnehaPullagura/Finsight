"""
Macroprudential Countercyclical Capital Buffer (CCyB 0-2.5%) Matrix
...
class CountercyclicalCapitalBufferCcybBankPortfolio(BaseModel):
...
class CountercyclicalCapitalBufferCcybAssetClassRWA(BaseModel):
    asset_class_name: str
    gross_exposure_amount: float
    applicable_risk_weight_pct: float
    calculated_rwa_amount: float

class CountercyclicalCapitalBufferCcybCapitalAdequacyResult(BaseModel):
    regulatory_framework: str = "Macroprudential Countercyclical Capital Buffer (CCyB 0-2.5%) Matrix"
    ...
    asset_class_rwa_breakdown: List[CountercyclicalCapitalBufferCcybAssetClassRWA]
    supervisory_recommendations: List[str]

class CountercyclicalCapitalBufferCcybEngine:
    @classmethod
    def evaluate_capital_adequacy(
        cls, p: CountercyclicalCapitalBufferCcybBankPortfolio
    ) -> CountercyclicalCapitalBufferCcybCapitalAdequacyResult:
        ...
        rwa_items = [
            CountercyclicalCapitalBufferCcybAssetClassRWA(
        ...
        return CountercyclicalCapitalBufferCcybCapitalAdequacyResult(
            regulatory_framework="Macroprudential Countercyclical Capital Buffer (CCyB 0-2.5%) Matrix",
