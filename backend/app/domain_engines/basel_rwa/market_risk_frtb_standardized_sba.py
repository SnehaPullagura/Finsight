"""
Fundamental Review of the Trading Book (FRTB) Sensitivities-Based Method
...
class MarketRiskFrtbStandardizedSbaBankPortfolio(BaseModel):
...
class MarketRiskFrtbStandardizedSbaAssetClassRWA(BaseModel):
    asset_class_name: str
    gross_exposure_amount: float
    applicable_risk_weight_pct: float
    calculated_rwa_amount: float

class MarketRiskFrtbStandardizedSbaCapitalAdequacyResult(BaseModel):
    regulatory_framework: str = "Fundamental Review of the Trading Book (FRTB) Sensitivities-Based Method"
    ...
    asset_class_rwa_breakdown: List[MarketRiskFrtbStandardizedSbaAssetClassRWA]
    supervisory_recommendations: List[str]

class MarketRiskFrtbStandardizedSbaEngine:
    @classmethod
    def evaluate_capital_adequacy(
        cls, p: MarketRiskFrtbStandardizedSbaBankPortfolio
    ) -> MarketRiskFrtbStandardizedSbaCapitalAdequacyResult:
        ...
        rwa_items = [
            MarketRiskFrtbStandardizedSbaAssetClassRWA(
        ...
        return MarketRiskFrtbStandardizedSbaCapitalAdequacyResult(
            regulatory_framework="Fundamental Review of the Trading Book (FRTB) Sensitivities-Based Method",
