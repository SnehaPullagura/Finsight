"""
Common Equity Tier 1 (CET1) & Capital Conservation Buffer (CCB 2.5%)
...
class CapitalConservationBufferCcbBankPortfolio(BaseModel):
...
class CapitalConservationBufferCcbAssetClassRWA(BaseModel):
    asset_class_name: str
    gross_exposure_amount: float
    applicable_risk_weight_pct: float
    calculated_rwa_amount: float

class CapitalConservationBufferCcbCapitalAdequacyResult(BaseModel):
    regulatory_framework: str = "Common Equity Tier 1 (CET1) & Capital Conservation Buffer (CCB 2.5%)"
    ...
    asset_class_rwa_breakdown: List[CapitalConservationBufferCcbAssetClassRWA]
    supervisory_recommendations: List[str]

class CapitalConservationBufferCcbEngine:
    @classmethod
    def evaluate_capital_adequacy(
        cls, p: CapitalConservationBufferCcbBankPortfolio
    ) -> CapitalConservationBufferCcbCapitalAdequacyResult:
        ...
        rwa_items = [
            CapitalConservationBufferCcbAssetClassRWA(
        ...
        return CapitalConservationBufferCcbCapitalAdequacyResult(
            regulatory_framework="Common Equity Tier 1 (CET1) & Capital Conservation Buffer (CCB 2.5%)",
