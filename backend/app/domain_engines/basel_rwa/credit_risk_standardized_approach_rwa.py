"""
Basel III Standardized Approach for Credit Risk (SA-CR) RWA Matrix
...
class CreditRiskStandardizedApproachRwaBankPortfolio(BaseModel):
...
class CreditRiskStandardizedApproachRwaAssetClassRWA(BaseModel):
    asset_class_name: str
    gross_exposure_amount: float
    applicable_risk_weight_pct: float
    calculated_rwa_amount: float

class CreditRiskStandardizedApproachRwaCapitalAdequacyResult(BaseModel):
    regulatory_framework: str = "Basel III Standardized Approach for Credit Risk (SA-CR) RWA Matrix"
    ...
    asset_class_rwa_breakdown: List[CreditRiskStandardizedApproachRwaAssetClassRWA]
    supervisory_recommendations: List[str]

class CreditRiskStandardizedApproachRwaEngine:
    @classmethod
    def evaluate_capital_adequacy(
        cls, p: CreditRiskStandardizedApproachRwaBankPortfolio
    ) -> CreditRiskStandardizedApproachRwaCapitalAdequacyResult:
        ...
        rwa_items = [
            CreditRiskStandardizedApproachRwaAssetClassRWA(
        ...
        return CreditRiskStandardizedApproachRwaCapitalAdequacyResult(
            regulatory_framework="Basel III Standardized Approach for Credit Risk (SA-CR) RWA Matrix",
