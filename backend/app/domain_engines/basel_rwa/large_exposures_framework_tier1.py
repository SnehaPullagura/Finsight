"""
Single Counterparty & Connected Group 20-25% Tier 1 Capital Exposure Cap
...
class LargeExposuresFrameworkTier1BankPortfolio(BaseModel):
...
class LargeExposuresFrameworkTier1AssetClassRWA(BaseModel):
    asset_class_name: str
    gross_exposure_amount: float
    applicable_risk_weight_pct: float
    calculated_rwa_amount: float

class LargeExposuresFrameworkTier1CapitalAdequacyResult(BaseModel):
    regulatory_framework: str = "Single Counterparty & Connected Group 20-25% Tier 1 Capital Exposure Cap"
    ...
    asset_class_rwa_breakdown: List[LargeExposuresFrameworkTier1AssetClassRWA]
    supervisory_recommendations: List[str]

class LargeExposuresFrameworkTier1Engine:
    @classmethod
    def evaluate_capital_adequacy(
        cls, p: LargeExposuresFrameworkTier1BankPortfolio
    ) -> LargeExposuresFrameworkTier1CapitalAdequacyResult:
        ...
        rwa_items = [
            LargeExposuresFrameworkTier1AssetClassRWA(
        ...
        return LargeExposuresFrameworkTier1CapitalAdequacyResult(
            regulatory_framework="Single Counterparty & Connected Group 20-25% Tier 1 Capital Exposure Cap",
