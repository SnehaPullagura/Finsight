"""
Basel III Tier 1 Leverage Ratio (Minimum 3.5% for Global/Domestic Banks)
...
class LeverageRatioExposureMeasureBankPortfolio(BaseModel):
...
class LeverageRatioExposureMeasureAssetClassRWA(BaseModel):
    asset_class_name: str
    gross_exposure_amount: float
    applicable_risk_weight_pct: float
    calculated_rwa_amount: float

class LeverageRatioExposureMeasureCapitalAdequacyResult(BaseModel):
    regulatory_framework: str = "Basel III Tier 1 Leverage Ratio (Minimum 3.5% for Global/Domestic Banks)"
    ...
    asset_class_rwa_breakdown: List[LeverageRatioExposureMeasureAssetClassRWA]
    supervisory_recommendations: List[str]

class LeverageRatioExposureMeasureEngine:
    @classmethod
    def evaluate_capital_adequacy(
        cls, p: LeverageRatioExposureMeasureBankPortfolio
    ) -> LeverageRatioExposureMeasureCapitalAdequacyResult:
        ...
        rwa_items = [
            LeverageRatioExposureMeasureAssetClassRWA(
        ...
        return LeverageRatioExposureMeasureCapitalAdequacyResult(
            regulatory_framework="Basel III Tier 1 Leverage Ratio (Minimum 3.5% for Global/Domestic Banks)",
