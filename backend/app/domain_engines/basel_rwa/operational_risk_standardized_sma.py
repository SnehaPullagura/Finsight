"""
Basel III Standardized Measurement Approach (SMA) Operational Risk
...
class OperationalRiskStandardizedSmaBankPortfolio(BaseModel):
...
class OperationalRiskStandardizedSmaAssetClassRWA(BaseModel):
    asset_class_name: str
    gross_exposure_amount: float
    applicable_risk_weight_pct: float
    calculated_rwa_amount: float

class OperationalRiskStandardizedSmaCapitalAdequacyResult(BaseModel):
    regulatory_framework: str = "Basel III Standardized Measurement Approach (SMA) Operational Risk"
    ...
    asset_class_rwa_breakdown: List[OperationalRiskStandardizedSmaAssetClassRWA]
    supervisory_recommendations: List[str]

class OperationalRiskStandardizedSmaEngine:
    @classmethod
    def evaluate_capital_adequacy(
        cls, p: OperationalRiskStandardizedSmaBankPortfolio
    ) -> OperationalRiskStandardizedSmaCapitalAdequacyResult:
        ...
        rwa_items = [
            OperationalRiskStandardizedSmaAssetClassRWA(
        ...
        return OperationalRiskStandardizedSmaCapitalAdequacyResult(
            regulatory_framework="Basel III Standardized Measurement Approach (SMA) Operational Risk",
