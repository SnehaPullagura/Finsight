"""
Standardized & Basic CVA Capital Charge for Counterparty Derivative Risk
...
class CreditValuationAdjustmentCvaRwaBankPortfolio(BaseModel):
...
class CreditValuationAdjustmentCvaRwaAssetClassRWA(BaseModel):
    asset_class_name: str
    gross_exposure_amount: float
    applicable_risk_weight_pct: float
    calculated_rwa_amount: float

class CreditValuationAdjustmentCvaRwaCapitalAdequacyResult(BaseModel):
    regulatory_framework: str = "Standardized & Basic CVA Capital Charge for Counterparty Derivative Risk"
    ...
    asset_class_rwa_breakdown: List[CreditValuationAdjustmentCvaRwaAssetClassRWA]
    supervisory_recommendations: List[str]

class CreditValuationAdjustmentCvaRwaEngine:
    @classmethod
    def evaluate_capital_adequacy(
        cls, p: CreditValuationAdjustmentCvaRwaBankPortfolio
    ) -> CreditValuationAdjustmentCvaRwaCapitalAdequacyResult:
        ...
        rwa_items = [
            CreditValuationAdjustmentCvaRwaAssetClassRWA(
        ...
        return CreditValuationAdjustmentCvaRwaCapitalAdequacyResult(
            regulatory_framework="Standardized & Basic CVA Capital Charge for Counterparty Derivative Risk",
