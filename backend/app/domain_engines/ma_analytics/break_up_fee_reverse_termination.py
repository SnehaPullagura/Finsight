"""
Reverse Termination & Break-Up Fee Liquidated Damages Engine
...
class BreakUpFeeReverseTerminationDealParameters(BaseModel):
...
class BreakUpFeeReverseTerminationAccretionResult(BaseModel):
    deal_title: str = "Reverse Termination & Break-Up Fee Liquidated Damages Engine"
...
class BreakUpFeeReverseTerminationEngine:
    @classmethod
    def evaluate_transaction(
        cls, d: BreakUpFeeReverseTerminationDealParameters
    ) -> BreakUpFeeReverseTerminationAccretionResult:
        ...
        return BreakUpFeeReverseTerminationAccretionResult(
