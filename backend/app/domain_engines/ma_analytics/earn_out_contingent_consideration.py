"""
Earn-Out Milestone Probability & Fair Value Discounting Matrix
...
class EarnOutContingentConsiderationDealParameters(BaseModel):
...
class EarnOutContingentConsiderationAccretionResult(BaseModel):
    deal_title: str = "Earn-Out Milestone Probability & Fair Value Discounting Matrix"
...
class EarnOutContingentConsiderationEngine:
    @classmethod
    def evaluate_transaction(
        cls, d: EarnOutContingentConsiderationDealParameters
    ) -> EarnOutContingentConsiderationAccretionResult:
        ...
        return EarnOutContingentConsiderationAccretionResult(
