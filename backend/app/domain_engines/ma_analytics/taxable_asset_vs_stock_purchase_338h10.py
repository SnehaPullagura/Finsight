"""
Section 338(h)(10) Deemed Asset Sale vs Stock Purchase Matrix
...
class TaxableAssetVsStockPurchase338H10DealParameters(BaseModel):
...
class TaxableAssetVsStockPurchase338H10AccretionResult(BaseModel):
    deal_title: str = "Section 338(h)(10) Deemed Asset Sale vs Stock Purchase Matrix"
...
class TaxableAssetVsStockPurchase338H10Engine:
    @classmethod
    def evaluate_transaction(
        cls, d: TaxableAssetVsStockPurchase338H10DealParameters
    ) -> TaxableAssetVsStockPurchase338H10AccretionResult:
        ...
        return TaxableAssetVsStockPurchase338H10AccretionResult(
