"""
Shareholder Rights Plan (Poison Pill) & Defense Mechanics
...
class HostileTakeoverDefensePoisonPillDealParameters(BaseModel):
...
class HostileTakeoverDefensePoisonPillAccretionResult(BaseModel):
    deal_title: str = "Shareholder Rights Plan (Poison Pill) & Defense Mechanics"
...
class HostileTakeoverDefensePoisonPillEngine:
    @classmethod
    def evaluate_transaction(
        cls, d: HostileTakeoverDefensePoisonPillDealParameters
    ) -> HostileTakeoverDefensePoisonPillAccretionResult:
        ...
        return HostileTakeoverDefensePoisonPillAccretionResult(
