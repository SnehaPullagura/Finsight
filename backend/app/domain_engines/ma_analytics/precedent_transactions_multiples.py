"""
Precedent Transactions (EV/EBITDA, EV/Sales) Benchmark Engine
...
class PrecedentTransactionsMultiplesDealParameters(BaseModel):
...
class PrecedentTransactionsMultiplesAccretionResult(BaseModel):
    deal_title: str = "Precedent Transactions (EV/EBITDA, EV/Sales) Benchmark Engine"
...
class PrecedentTransactionsMultiplesEngine:
    @classmethod
    def evaluate_transaction(
        cls, d: PrecedentTransactionsMultiplesDealParameters
    ) -> PrecedentTransactionsMultiplesAccretionResult:
        ...
        return PrecedentTransactionsMultiplesAccretionResult(
