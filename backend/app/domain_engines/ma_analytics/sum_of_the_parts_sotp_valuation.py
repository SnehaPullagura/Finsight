"""
Sum-of-the-Parts (SOTP) Conglomerate Discount Valuation Engine
...
class SumOfThePartsSotpValuationDealParameters(BaseModel):
...
class SumOfThePartsSotpValuationAccretionResult(BaseModel):
    deal_title: str = "Sum-of-the-Parts (SOTP) Conglomerate Discount Valuation Engine"
...
class SumOfThePartsSotpValuationEngine:
    @classmethod
    def evaluate_transaction(
        cls, d: SumOfThePartsSotpValuationDealParameters
    ) -> SumOfThePartsSotpValuationAccretionResult:
        ...
        return SumOfThePartsSotpValuationAccretionResult(
