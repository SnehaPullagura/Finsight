"""
M&A EPS Accretion / Dilution & Synergy Breakeven Calculator
...
class MaAccretionDilutionEpsModelDealParameters(BaseModel):
...
class MaAccretionDilutionEpsModelAccretionResult(BaseModel):
    deal_title: str = "M&A EPS Accretion / Dilution & Synergy Breakeven Calculator"
...
class MaAccretionDilutionEpsModelEngine:
    @classmethod
    def evaluate_transaction(
        cls, d: MaAccretionDilutionEpsModelDealParameters
    ) -> MaAccretionDilutionEpsModelAccretionResult:
        ...
        return MaAccretionDilutionEpsModelAccretionResult(
