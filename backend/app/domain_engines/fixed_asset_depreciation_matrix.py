"""
Straight Line, WDV and Units of Production Depreciation Schedules
Module Index: 34 of 50
...
class FixedAssetDepreciationMatrixInputParameters(BaseModel):
...
class FixedAssetDepreciationMatrixPeriodScheduleItem(BaseModel):
    period_sequence: int
    period_label: str
...
class FixedAssetDepreciationMatrixEngineResult(BaseModel):
    engine_name: str = "Straight Line, WDV and Units of Production Depreciation Schedules"
    ...
    detailed_period_waterfall: List[FixedAssetDepreciationMatrixPeriodScheduleItem]
    optimization_recommendations: List[str]

class FixedAssetDepreciationMatrixEngine:
    """
    Institutional Implementation of Straight Line, WDV and Units of Production Depreciation Schedules.
    Provides quantitative modeling, regulatory compliance, stress testing, and cash-flow waterfall calculations.
    """
    @classmethod
    def execute_analysis(cls, params: FixedAssetDepreciationMatrixInputParameters) -> FixedAssetDepreciationMatrixEngineResult:
        r_step = (params.annual_operational_rate_pct / 100.0) / 12.0
        curr_val = params.primary_capital_value
        today = datetime.date.today()
        
        waterfall: List[FixedAssetDepreciationMatrixPeriodScheduleItem] = []
        tot_inflows = 0.0
        tot_outflows = 0.0
        ...
        for step in range(1, params.simulation_duration_periods + 1):
            ...
            waterfall.append(FixedAssetDepreciationMatrixPeriodScheduleItem(
        ...
        return FixedAssetDepreciationMatrixEngineResult(
