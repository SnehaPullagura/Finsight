"""
ABS Tranche Subordination & Cash-Flow Payment Waterfall Engine
...
class AssetBackedSecuritizationWaterfallInstrumentParameters(BaseModel):
...
class AssetBackedSecuritizationWaterfallCashFlowPoint(BaseModel):
    period_number: int
    due_date: str
...
class AssetBackedSecuritizationWaterfallValuationResult(BaseModel):
    instrument_title: str = "ABS Tranche Subordination & Cash-Flow Payment Waterfall Engine"
    ...
    cash_flow_timeline: List[AssetBackedSecuritizationWaterfallCashFlowPoint]
    risk_sensitivities: Dict[str, float]

class AssetBackedSecuritizationWaterfallEngine:
    @classmethod
    def calculate_valuation(
        cls, params: AssetBackedSecuritizationWaterfallInstrumentParameters
    ) -> AssetBackedSecuritizationWaterfallValuationResult:
        ...
        timeline: List[AssetBackedSecuritizationWaterfallCashFlowPoint] = []
        ...
        for t in range(1, n_periods + 1):
            ...
            timeline.append(AssetBackedSecuritizationWaterfallCashFlowPoint(
                period_number=t,
        ...
        return AssetBackedSecuritizationWaterfallValuationResult(
