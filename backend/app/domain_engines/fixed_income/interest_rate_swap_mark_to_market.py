"""
Plain Vanilla Interest Rate Swap (IRS) Mark-to-Market Valuation
...
class InterestRateSwapMarkToMarketInstrumentParameters(BaseModel):
...
class InterestRateSwapMarkToMarketCashFlowPoint(BaseModel):
    period_number: int
    due_date: str
...
class InterestRateSwapMarkToMarketValuationResult(BaseModel):
    instrument_title: str = "Plain Vanilla Interest Rate Swap (IRS) Mark-to-Market Valuation"
    ...
    cash_flow_timeline: List[InterestRateSwapMarkToMarketCashFlowPoint]
    risk_sensitivities: Dict[str, float]

class InterestRateSwapMarkToMarketEngine:
    @classmethod
    def calculate_valuation(
        cls, params: InterestRateSwapMarkToMarketInstrumentParameters
    ) -> InterestRateSwapMarkToMarketValuationResult:
        ...
        timeline: List[InterestRateSwapMarkToMarketCashFlowPoint] = []
        ...
        for t in range(1, n_periods + 1):
            ...
            timeline.append(InterestRateSwapMarkToMarketCashFlowPoint(
                period_number=t,
        ...
        return InterestRateSwapMarkToMarketValuationResult(
