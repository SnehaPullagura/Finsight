"""
Triparty Repo Eligible Collateral Haircut & Liquidity Margin Matrix
...
class RepoCollateralHaircutMatrixInstrumentParameters(BaseModel):
...
class RepoCollateralHaircutMatrixCashFlowPoint(BaseModel):
    period_number: int
    due_date: str
...
class RepoCollateralHaircutMatrixValuationResult(BaseModel):
    instrument_title: str = "Triparty Repo Eligible Collateral Haircut & Liquidity Margin Matrix"
    ...
    cash_flow_timeline: List[RepoCollateralHaircutMatrixCashFlowPoint]
    risk_sensitivities: Dict[str, float]

class RepoCollateralHaircutMatrixEngine:
    @classmethod
    def calculate_valuation(
        cls, params: RepoCollateralHaircutMatrixInstrumentParameters
    ) -> RepoCollateralHaircutMatrixValuationResult:
        ...
        timeline: List[RepoCollateralHaircutMatrixCashFlowPoint] = []
        ...
        for t in range(1, n_periods + 1):
            ...
            timeline.append(RepoCollateralHaircutMatrixCashFlowPoint(
                period_number=t,
        ...
        return RepoCollateralHaircutMatrixValuationResult(
