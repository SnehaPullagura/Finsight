"""
MBS Prepayment Single Monthly Mortality (SMM) & PSA Benchmark Engine
...
class MortgageBackedSecurityPrepayInstrumentParameters(BaseModel):
...
class MortgageBackedSecurityPrepayCashFlowPoint(BaseModel):
    period_number: int
    due_date: str
...
class MortgageBackedSecurityPrepayValuationResult(BaseModel):
    instrument_title: str = "MBS Prepayment Single Monthly Mortality (SMM) & PSA Benchmark Engine"
    ...
    cash_flow_timeline: List[MortgageBackedSecurityPrepayCashFlowPoint]
    risk_sensitivities: Dict[str, float]

class MortgageBackedSecurityPrepayEngine:
    @classmethod
    def calculate_valuation(
        cls, params: MortgageBackedSecurityPrepayInstrumentParameters
    ) -> MortgageBackedSecurityPrepayValuationResult:
        ...
        timeline: List[MortgageBackedSecurityPrepayCashFlowPoint] = []
        ...
        for t in range(1, n_periods + 1):
            ...
            timeline.append(MortgageBackedSecurityPrepayCashFlowPoint(
                period_number=t,
        ...
        return MortgageBackedSecurityPrepayValuationResult(
