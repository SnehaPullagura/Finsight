"""
Constant Maturity Swap (CMS) Convexity & Timing Adjustment Engine
...
class ConstantMaturitySwapCmsSpreadInstrumentParameters(BaseModel):
...
class ConstantMaturitySwapCmsSpreadCashFlowPoint(BaseModel):
    period_number: int
    due_date: str
...
class ConstantMaturitySwapCmsSpreadValuationResult(BaseModel):
    instrument_title: str = "Constant Maturity Swap (CMS) Convexity & Timing Adjustment Engine"
    ...
    cash_flow_timeline: List[ConstantMaturitySwapCmsSpreadCashFlowPoint]
    risk_sensitivities: Dict[str, float]

class ConstantMaturitySwapCmsSpreadEngine:
    @classmethod
    def calculate_valuation(
        cls, params: ConstantMaturitySwapCmsSpreadInstrumentParameters
    ) -> ConstantMaturitySwapCmsSpreadValuationResult:
        ...
        timeline: List[ConstantMaturitySwapCmsSpreadCashFlowPoint] = []
        ...
        for t in range(1, n_periods + 1):
            ...
            timeline.append(ConstantMaturitySwapCmsSpreadCashFlowPoint(
                period_number=t,
        ...
        return ConstantMaturitySwapCmsSpreadValuationResult(
