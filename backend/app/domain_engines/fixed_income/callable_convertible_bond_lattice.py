"""
Trinomial Lattice Valuation for Callable Convertible Corporate Debt
...
class CallableConvertibleBondLatticeInstrumentParameters(BaseModel):
...
class CallableConvertibleBondLatticeCashFlowPoint(BaseModel):
    period_number: int
    due_date: str
...
class CallableConvertibleBondLatticeValuationResult(BaseModel):
    instrument_title: str = "Trinomial Lattice Valuation for Callable Convertible Corporate Debt"
    ...
    cash_flow_timeline: List[CallableConvertibleBondLatticeCashFlowPoint]
    risk_sensitivities: Dict[str, float]

class CallableConvertibleBondLatticeEngine:
    @classmethod
    def calculate_valuation(
        cls, params: CallableConvertibleBondLatticeInstrumentParameters
    ) -> CallableConvertibleBondLatticeValuationResult:
        ...
        timeline: List[CallableConvertibleBondLatticeCashFlowPoint] = []
        ...
        for t in range(1, n_periods + 1):
            ...
            timeline.append(CallableConvertibleBondLatticeCashFlowPoint(
                period_number=t,
        ...
        return CallableConvertibleBondLatticeValuationResult(
