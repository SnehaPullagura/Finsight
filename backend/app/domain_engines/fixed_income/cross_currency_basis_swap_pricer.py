"""
Cross-Currency Basis Swap (CCBS) Multi-Curve Discounting Engine
...
class CrossCurrencyBasisSwapPricerInstrumentParameters(BaseModel):
...
class CrossCurrencyBasisSwapPricerCashFlowPoint(BaseModel):
    period_number: int
    due_date: str
...
class CrossCurrencyBasisSwapPricerValuationResult(BaseModel):
    instrument_title: str = "Cross-Currency Basis Swap (CCBS) Multi-Curve Discounting Engine"
    ...
    cash_flow_timeline: List[CrossCurrencyBasisSwapPricerCashFlowPoint]
    risk_sensitivities: Dict[str, float]

class CrossCurrencyBasisSwapPricerEngine:
    @classmethod
    def calculate_valuation(
        cls, params: CrossCurrencyBasisSwapPricerInstrumentParameters
    ) -> CrossCurrencyBasisSwapPricerValuationResult:
        ...
        timeline: List[CrossCurrencyBasisSwapPricerCashFlowPoint] = []
        ...
        for t in range(1, n_periods + 1):
            ...
            timeline.append(CrossCurrencyBasisSwapPricerCashFlowPoint(
                period_number=t,
        ...
        return CrossCurrencyBasisSwapPricerValuationResult(
