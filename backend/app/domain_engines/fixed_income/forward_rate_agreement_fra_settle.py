"""
Forward Rate Agreement (FRA) Intrinsic Rate & Settlement Cash Engine
...
class ForwardRateAgreementFraSettleInstrumentParameters(BaseModel):
...
class ForwardRateAgreementFraSettleCashFlowPoint(BaseModel):
    period_number: int
    due_date: str
...
class ForwardRateAgreementFraSettleValuationResult(BaseModel):
    instrument_title: str = "Forward Rate Agreement (FRA) Intrinsic Rate & Settlement Cash Engine"
    ...
    cash_flow_timeline: List[ForwardRateAgreementFraSettleCashFlowPoint]
    risk_sensitivities: Dict[str, float]

class ForwardRateAgreementFraSettleEngine:
    @classmethod
    def calculate_valuation(
        cls, params: ForwardRateAgreementFraSettleInstrumentParameters
    ) -> ForwardRateAgreementFraSettleValuationResult:
        ...
        timeline: List[ForwardRateAgreementFraSettleCashFlowPoint] = []
        ...
        for t in range(1, n_periods + 1):
            ...
            timeline.append(ForwardRateAgreementFraSettleCashFlowPoint(
                period_number=t,
        ...
        return ForwardRateAgreementFraSettleValuationResult(
