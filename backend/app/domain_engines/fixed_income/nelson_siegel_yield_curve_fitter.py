"""
Nelson-Siegel-Svensson 6-Parameter Zero-Coupon Yield Curve Fitter
...
class NelsonSiegelYieldCurveFitterInstrumentParameters(BaseModel):
...
class NelsonSiegelYieldCurveFitterCashFlowPoint(BaseModel):
    period_number: int
    due_date: str
...
class NelsonSiegelYieldCurveFitterValuationResult(BaseModel):
    instrument_title: str = "Nelson-Siegel-Svensson 6-Parameter Zero-Coupon Yield Curve Fitter"
    ...
    cash_flow_timeline: List[NelsonSiegelYieldCurveFitterCashFlowPoint]
    risk_sensitivities: Dict[str, float]

class NelsonSiegelYieldCurveFitterEngine:
    @classmethod
    def calculate_valuation(
        cls, params: NelsonSiegelYieldCurveFitterInstrumentParameters
    ) -> NelsonSiegelYieldCurveFitterValuationResult:
        ...
        timeline: List[NelsonSiegelYieldCurveFitterCashFlowPoint] = []
        ...
        for t in range(1, n_periods + 1):
            ...
            timeline.append(NelsonSiegelYieldCurveFitterCashFlowPoint(
                period_number=t,
        ...
        return NelsonSiegelYieldCurveFitterValuationResult(
