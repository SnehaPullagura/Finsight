"""
Floating Rate Note (FRN) Discount Margin & Quoted Margin Calculator
...
class FloatingRateNoteDiscountMarginInstrumentParameters(BaseModel):
...
class FloatingRateNoteDiscountMarginCashFlowPoint(BaseModel):
    period_number: int
    due_date: str
...
class FloatingRateNoteDiscountMarginValuationResult(BaseModel):
    instrument_title: str = "Floating Rate Note (FRN) Discount Margin & Quoted Margin Calculator"
    ...
    cash_flow_timeline: List[FloatingRateNoteDiscountMarginCashFlowPoint]
    risk_sensitivities: Dict[str, float]

class FloatingRateNoteDiscountMarginEngine:
    @classmethod
    def calculate_valuation(
        cls, params: FloatingRateNoteDiscountMarginInstrumentParameters
    ) -> FloatingRateNoteDiscountMarginValuationResult:
        ...
        timeline: List[FloatingRateNoteDiscountMarginCashFlowPoint] = []
        ...
        for t in range(1, n_periods + 1):
            ...
            timeline.append(FloatingRateNoteDiscountMarginCashFlowPoint(
                period_number=t,
        ...
        return FloatingRateNoteDiscountMarginValuationResult(
