"""
European Credit Default Swaption (Payer/Receiver) Black-76 Engine
...
class CreditDefaultSwaptionBlack76InstrumentParameters(BaseModel):
...
class CreditDefaultSwaptionBlack76CashFlowPoint(BaseModel):
    period_number: int
    due_date: str
...
class CreditDefaultSwaptionBlack76ValuationResult(BaseModel):
    instrument_title: str = "European Credit Default Swaption (Payer/Receiver) Black-76 Engine"
    ...
    cash_flow_timeline: List[CreditDefaultSwaptionBlack76CashFlowPoint]
    risk_sensitivities: Dict[str, float]

class CreditDefaultSwaptionBlack76Engine:
    @classmethod
    def calculate_valuation(
        cls, params: CreditDefaultSwaptionBlack76InstrumentParameters
    ) -> CreditDefaultSwaptionBlack76ValuationResult:
        ...
        timeline: List[CreditDefaultSwaptionBlack76CashFlowPoint] = []
        ...
        for t in range(1, n_periods + 1):
            ...
            timeline.append(CreditDefaultSwaptionBlack76CashFlowPoint(
                period_number=t,
        ...
        return CreditDefaultSwaptionBlack76ValuationResult(
