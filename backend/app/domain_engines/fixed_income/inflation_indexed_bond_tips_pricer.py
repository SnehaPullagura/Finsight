"""
Inflation-Indexed Bonds (TIPS / IIBs) Principal Adjustment Engine
...
class InflationIndexedBondTipsPricerInstrumentParameters(BaseModel):
...
class InflationIndexedBondTipsPricerCashFlowPoint(BaseModel):
    period_number: int
    due_date: str
...
class InflationIndexedBondTipsPricerValuationResult(BaseModel):
    instrument_title: str = "Inflation-Indexed Bonds (TIPS / IIBs) Principal Adjustment Engine"
    ...
    cash_flow_timeline: List[InflationIndexedBondTipsPricerCashFlowPoint]
    risk_sensitivities: Dict[str, float]

class InflationIndexedBondTipsPricerEngine:
    @classmethod
    def calculate_valuation(
        cls, params: InflationIndexedBondTipsPricerInstrumentParameters
    ) -> InflationIndexedBondTipsPricerValuationResult:
        ...
        timeline: List[InflationIndexedBondTipsPricerCashFlowPoint] = []
        ...
        for t in range(1, n_periods + 1):
            ...
            timeline.append(InflationIndexedBondTipsPricerCashFlowPoint(
                period_number=t,
        ...
        return InflationIndexedBondTipsPricerValuationResult(
