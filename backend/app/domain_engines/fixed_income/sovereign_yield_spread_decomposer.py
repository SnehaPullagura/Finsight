"""
Sovereign G-Spread, I-Spread, Z-Spread and OAS Credit Decomposer
...
class SovereignYieldSpreadDecomposerInstrumentParameters(BaseModel):
...
class SovereignYieldSpreadDecomposerCashFlowPoint(BaseModel):
    period_number: int
    due_date: str
...
class SovereignYieldSpreadDecomposerValuationResult(BaseModel):
    instrument_title: str = "Sovereign G-Spread, I-Spread, Z-Spread and OAS Credit Decomposer"
    ...
    cash_flow_timeline: List[SovereignYieldSpreadDecomposerCashFlowPoint]
    risk_sensitivities: Dict[str, float]

class SovereignYieldSpreadDecomposerEngine:
    @classmethod
    def calculate_valuation(
        cls, params: SovereignYieldSpreadDecomposerInstrumentParameters
    ) -> SovereignYieldSpreadDecomposerValuationResult:
        ...
        timeline: List[SovereignYieldSpreadDecomposerCashFlowPoint] = []
        ...
        for t in range(1, n_periods + 1):
            ...
            timeline.append(SovereignYieldSpreadDecomposerCashFlowPoint(
                period_number=t,
        ...
        return SovereignYieldSpreadDecomposerValuationResult(
