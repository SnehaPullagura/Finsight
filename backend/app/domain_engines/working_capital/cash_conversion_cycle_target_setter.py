"""
Industry Peer Benchmark Days Sales Outstanding (DSO) Target Engine
...
class CashConversionCycleTargetSetterParameters(BaseModel):
...
class CashConversionCycleTargetSetterScheduleItem(BaseModel):
    batch_index: int
    cycle_date: str
...
class CashConversionCycleTargetSetterAnalysisResult(BaseModel):
    engine_title: str = "Industry Peer Benchmark Days Sales Outstanding (DSO) Target Engine"
    ...
    operational_schedule: List[CashConversionCycleTargetSetterScheduleItem]
    governance_advisories: List[str]

class CashConversionCycleTargetSetterEngine:
    @classmethod
    def compute_optimization(cls, params: CashConversionCycleTargetSetterParameters) -> CashConversionCycleTargetSetterAnalysisResult:
        ...
        schedule: List[CashConversionCycleTargetSetterScheduleItem] = []
        ...
        for m in range(1, 13):
            ...
            schedule.append(CashConversionCycleTargetSetterScheduleItem(
                batch_index=m,
        ...
        return CashConversionCycleTargetSetterAnalysisResult(
