"""
Supplier Payment Terms Extension & Working Capital Release Simulator
...
class SupplierCreditTermsOptimizerParameters(BaseModel):
...
class SupplierCreditTermsOptimizerScheduleItem(BaseModel):
    batch_index: int
    cycle_date: str
...
class SupplierCreditTermsOptimizerAnalysisResult(BaseModel):
    engine_title: str = "Supplier Payment Terms Extension & Working Capital Release Simulator"
    ...
    operational_schedule: List[SupplierCreditTermsOptimizerScheduleItem]
    governance_advisories: List[str]

class SupplierCreditTermsOptimizerEngine:
    @classmethod
    def compute_optimization(cls, params: SupplierCreditTermsOptimizerParameters) -> SupplierCreditTermsOptimizerAnalysisResult:
        ...
        schedule: List[SupplierCreditTermsOptimizerScheduleItem] = []
        ...
        for m in range(1, 13):
            ...
            schedule.append(SupplierCreditTermsOptimizerScheduleItem(
                batch_index=m,
        ...
        return SupplierCreditTermsOptimizerAnalysisResult(
