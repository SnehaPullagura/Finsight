"""
Lower of Cost or Net Realizable Value (NRV) Inventory Impairment Matrix
...
class ObsoleteInventoryWriteDownMatrixParameters(BaseModel):
...
class ObsoleteInventoryWriteDownMatrixScheduleItem(BaseModel):
    batch_index: int
    cycle_date: str
...
class ObsoleteInventoryWriteDownMatrixAnalysisResult(BaseModel):
    engine_title: str = "Lower of Cost or Net Realizable Value (NRV) Inventory Impairment Matrix"
    ...
    operational_schedule: List[ObsoleteInventoryWriteDownMatrixScheduleItem]
    governance_advisories: List[str]

class ObsoleteInventoryWriteDownMatrixEngine:
    @classmethod
    def compute_optimization(cls, params: ObsoleteInventoryWriteDownMatrixParameters) -> ObsoleteInventoryWriteDownMatrixAnalysisResult:
        ...
        schedule: List[ObsoleteInventoryWriteDownMatrixScheduleItem] = []
        ...
        for m in range(1, 13):
            ...
            schedule.append(ObsoleteInventoryWriteDownMatrixScheduleItem(
                batch_index=m,
        ...
        return ObsoleteInventoryWriteDownMatrixAnalysisResult(
