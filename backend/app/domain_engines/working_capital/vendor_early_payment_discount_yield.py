"""
2/10 Net 30 Commercial Discount APR & Cost of Capital Arbitrage
...
class VendorEarlyPaymentDiscountYieldParameters(BaseModel):
...
class VendorEarlyPaymentDiscountYieldScheduleItem(BaseModel):
    batch_index: int
    cycle_date: str
...
class VendorEarlyPaymentDiscountYieldAnalysisResult(BaseModel):
    engine_title: str = "2/10 Net 30 Commercial Discount APR & Cost of Capital Arbitrage"
    ...
    operational_schedule: List[VendorEarlyPaymentDiscountYieldScheduleItem]
    governance_advisories: List[str]

class VendorEarlyPaymentDiscountYieldEngine:
    @classmethod
    def compute_optimization(cls, params: VendorEarlyPaymentDiscountYieldParameters) -> VendorEarlyPaymentDiscountYieldAnalysisResult:
        ...
        schedule: List[VendorEarlyPaymentDiscountYieldScheduleItem] = []
        ...
        for m in range(1, 13):
            ...
            schedule.append(VendorEarlyPaymentDiscountYieldScheduleItem(
                batch_index=m,
        ...
        return VendorEarlyPaymentDiscountYieldAnalysisResult(
