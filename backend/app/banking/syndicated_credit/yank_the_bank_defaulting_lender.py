"""
Yank-the-Bank Non-Consenting & Defaulting Lender Replacement Engine
...
class YankTheBankDefaultingLenderSyndicateStructure(BaseModel):
...
class YankTheBankDefaultingLenderParticipantLender(BaseModel):
    lender_bic: str
    lender_name: str
...
class YankTheBankDefaultingLenderFacilitySummary(BaseModel):
    facility_name: str = "Yank-the-Bank Non-Consenting & Defaulting Lender Replacement Engine"
    ...
    lenders_syndicate: List[YankTheBankDefaultingLenderParticipantLender]
    governance_covenants: List[str]

class YankTheBankDefaultingLenderEngine:
    @classmethod
    def manage_syndicate(
        cls, s: YankTheBankDefaultingLenderSyndicateStructure
    ) -> YankTheBankDefaultingLenderFacilitySummary:
        ...
        lenders: List[YankTheBankDefaultingLenderParticipantLender] = []
        for name, pct in banks_config:
            comm = tot_vol * pct
            int_mo = monthly_interest * pct
            lenders.append(YankTheBankDefaultingLenderParticipantLender(
        ...
        return YankTheBankDefaultingLenderFacilitySummary(
