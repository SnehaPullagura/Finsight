"""
Security Trustee Intercreditor Pari-Passu Collateral Custody Engine
...
class SecurityTrusteeCovenantCustodySyndicateStructure(BaseModel):
...
class SecurityTrusteeCovenantCustodyParticipantLender(BaseModel):
    lender_bic: str
    lender_name: str
...
class SecurityTrusteeCovenantCustodyFacilitySummary(BaseModel):
    facility_name: str = "Security Trustee Intercreditor Pari-Passu Collateral Custody Engine"
    ...
    lenders_syndicate: List[SecurityTrusteeCovenantCustodyParticipantLender]
    governance_covenants: List[str]

class SecurityTrusteeCovenantCustodyEngine:
    @classmethod
    def manage_syndicate(
        cls, s: SecurityTrusteeCovenantCustodySyndicateStructure
    ) -> SecurityTrusteeCovenantCustodyFacilitySummary:
        ...
        lenders: List[SecurityTrusteeCovenantCustodyParticipantLender] = []
        for name, pct in banks_config:
            comm = tot_vol * pct
            int_mo = monthly_interest * pct
            lenders.append(SecurityTrusteeCovenantCustodyParticipantLender(
        ...
        return SecurityTrusteeCovenantCustodyFacilitySummary(
