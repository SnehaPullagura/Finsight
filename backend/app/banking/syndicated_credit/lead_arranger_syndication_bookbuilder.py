"""
Mandated Lead Arranger (MLA) Syndication Bookbuilding Engine
...
class LeadArrangerSyndicationBookbuilderSyndicateStructure(BaseModel):
...
class LeadArrangerSyndicationBookbuilderParticipantLender(BaseModel):
    lender_bic: str
    lender_name: str
...
class LeadArrangerSyndicationBookbuilderFacilitySummary(BaseModel):
    facility_name: str = "Mandated Lead Arranger (MLA) Syndication Bookbuilding Engine"
    ...
    lenders_syndicate: List[LeadArrangerSyndicationBookbuilderParticipantLender]
    governance_covenants: List[str]

class LeadArrangerSyndicationBookbuilderEngine:
    @classmethod
    def manage_syndicate(
        cls, s: LeadArrangerSyndicationBookbuilderSyndicateStructure
    ) -> LeadArrangerSyndicationBookbuilderFacilitySummary:
        ...
        lenders: List[LeadArrangerSyndicationBookbuilderParticipantLender] = []
        for name, pct in banks_config:
            comm = tot_vol * pct
            int_mo = monthly_interest * pct
            lenders.append(LeadArrangerSyndicationBookbuilderParticipantLender(
        ...
        return LeadArrangerSyndicationBookbuilderFacilitySummary(
