"""
Annual 30-Consecutive-Day Working Capital Clean-Down Enforcer
...
class CleanDownPeriodRevolvingFacilitySyndicateStructure(BaseModel):
...
class CleanDownPeriodRevolvingFacilityParticipantLender(BaseModel):
    lender_bic: str
    lender_name: str
...
class CleanDownPeriodRevolvingFacilityFacilitySummary(BaseModel):
    facility_name: str = "Annual 30-Consecutive-Day Working Capital Clean-Down Enforcer"
    ...
    lenders_syndicate: List[CleanDownPeriodRevolvingFacilityParticipantLender]
    governance_covenants: List[str]

class CleanDownPeriodRevolvingFacilityEngine:
    @classmethod
    def manage_syndicate(
        cls, s: CleanDownPeriodRevolvingFacilitySyndicateStructure
    ) -> CleanDownPeriodRevolvingFacilityFacilitySummary:
        ...
        lenders: List[CleanDownPeriodRevolvingFacilityParticipantLender] = []
        for name, pct in banks_config:
            comm = tot_vol * pct
            int_mo = monthly_interest * pct
            lenders.append(CleanDownPeriodRevolvingFacilityParticipantLender(
        ...
        return CleanDownPeriodRevolvingFacilityFacilitySummary(
