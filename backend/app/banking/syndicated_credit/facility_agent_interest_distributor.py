"""
Facility Agent Multilateral Interest & Principal Waterfall Engine
...
class FacilityAgentInterestDistributorSyndicateStructure(BaseModel):
...
class FacilityAgentInterestDistributorParticipantLender(BaseModel):
    lender_bic: str
    lender_name: str
...
class FacilityAgentInterestDistributorFacilitySummary(BaseModel):
    facility_name: str = "Facility Agent Multilateral Interest & Principal Waterfall Engine"
    ...
    lenders_syndicate: List[FacilityAgentInterestDistributorParticipantLender]
    governance_covenants: List[str]

class FacilityAgentInterestDistributorEngine:
    @classmethod
    def manage_syndicate(
        cls, s: FacilityAgentInterestDistributorSyndicateStructure
    ) -> FacilityAgentInterestDistributorFacilitySummary:
        ...
        lenders: List[FacilityAgentInterestDistributorParticipantLender] = []
        for name, pct in banks_config:
            comm = tot_vol * pct
            int_mo = monthly_interest * pct
            lenders.append(FacilityAgentInterestDistributorParticipantLender(
        ...
        return FacilityAgentInterestDistributorFacilitySummary(
