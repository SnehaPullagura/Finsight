"""
Swingline Sub-Facility & Fronting Bank Letter of Credit Matrix
...
class SwinglineFrontingBankReimburseSyndicateStructure(BaseModel):
...
class SwinglineFrontingBankReimburseParticipantLender(BaseModel):
    lender_bic: str
    lender_name: str
...
class SwinglineFrontingBankReimburseFacilitySummary(BaseModel):
    facility_name: str = "Swingline Sub-Facility & Fronting Bank Letter of Credit Matrix"
    ...
    lenders_syndicate: List[SwinglineFrontingBankReimburseParticipantLender]
    governance_covenants: List[str]

class SwinglineFrontingBankReimburseEngine:
    @classmethod
    def manage_syndicate(
        cls, s: SwinglineFrontingBankReimburseSyndicateStructure
    ) -> SwinglineFrontingBankReimburseFacilitySummary:
        ...
        lenders: List[SwinglineFrontingBankReimburseParticipantLender] = []
        for name, pct in banks_config:
            comm = tot_vol * pct
            int_mo = monthly_interest * pct
            lenders.append(SwinglineFrontingBankReimburseParticipantLender(
        ...
        return SwinglineFrontingBankReimburseFacilitySummary(
