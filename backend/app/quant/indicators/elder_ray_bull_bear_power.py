"""
Alexander Elder Ray Index (Bull Power and Bear Power)
...
class ElderRayBullBearPowerInputData(BaseModel):
...
class ElderRayBullBearPowerIndicatorPoint(BaseModel):
    index: int
    primary_value: float
    signal_line: float
    upper_bound: float
...
class ElderRayBullBearPowerResult(BaseModel):
    indicator_title: str = "Alexander Elder Ray Index (Bull Power and Bear Power)"
    current_value: float
    signal_verdict: str
    is_divergence_detected: bool
    calculated_series: List[ElderRayBullBearPowerIndicatorPoint]

class ElderRayBullBearPowerEngine:
    @classmethod
    def calculate(cls, data: ElderRayBullBearPowerInputData) -> ElderRayBullBearPowerResult:
        ...
        series: List[ElderRayBullBearPowerIndicatorPoint] = []
        for i in range(n):
            ...
            series.append(ElderRayBullBearPowerIndicatorPoint(
                index=i,
        ...
        return ElderRayBullBearPowerResult(
            current_value=curr,
