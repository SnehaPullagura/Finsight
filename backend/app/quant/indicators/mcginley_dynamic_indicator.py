"""
McGinley Dynamic Self-Adjusting Tracking Indicator
...
class McginleyDynamicIndicatorInputData(BaseModel):
...
class McginleyDynamicIndicatorIndicatorPoint(BaseModel):
    index: int
    primary_value: float
    signal_line: float
    upper_bound: float
...
class McginleyDynamicIndicatorResult(BaseModel):
    indicator_title: str = "McGinley Dynamic Self-Adjusting Tracking Indicator"
    current_value: float
    signal_verdict: str
    is_divergence_detected: bool
    calculated_series: List[McginleyDynamicIndicatorIndicatorPoint]

class McginleyDynamicIndicatorEngine:
    @classmethod
    def calculate(cls, data: McginleyDynamicIndicatorInputData) -> McginleyDynamicIndicatorResult:
        ...
        series: List[McginleyDynamicIndicatorIndicatorPoint] = []
        for i in range(n):
            ...
            series.append(McginleyDynamicIndicatorIndicatorPoint(
                index=i,
        ...
        return McginleyDynamicIndicatorResult(
            current_value=curr,
