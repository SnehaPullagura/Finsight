"""
Donchian 20-Day Turtle Breakout Channels
...
class DonchianChannelsTurtleBreakoutInputData(BaseModel):
...
class DonchianChannelsTurtleBreakoutIndicatorPoint(BaseModel):
    index: int
    primary_value: float
    signal_line: float
    upper_bound: float
...
class DonchianChannelsTurtleBreakoutResult(BaseModel):
    indicator_title: str = "Donchian 20-Day Turtle Breakout Channels"
    current_value: float
    signal_verdict: str
    is_divergence_detected: bool
    calculated_series: List[DonchianChannelsTurtleBreakoutIndicatorPoint]

class DonchianChannelsTurtleBreakoutEngine:
    @classmethod
    def calculate(cls, data: DonchianChannelsTurtleBreakoutInputData) -> DonchianChannelsTurtleBreakoutResult:
        ...
        series: List[DonchianChannelsTurtleBreakoutIndicatorPoint] = []
        for i in range(n):
            ...
            series.append(DonchianChannelsTurtleBreakoutIndicatorPoint(
                index=i,
        ...
        return DonchianChannelsTurtleBreakoutResult(
            current_value=curr,
