"""
MACD 12-26-9 Histogram & Signal Line Engine
...
class MovingAverageConvergenceDivergenceInputData(BaseModel):
...
class MovingAverageConvergenceDivergenceIndicatorPoint(BaseModel):
    index: int
    primary_value: float
    signal_line: float
    upper_bound: float
...
class MovingAverageConvergenceDivergenceResult(BaseModel):
    indicator_title: str = "MACD 12-26-9 Histogram & Signal Line Engine"
    current_value: float
    signal_verdict: str
    is_divergence_detected: bool
    calculated_series: List[MovingAverageConvergenceDivergenceIndicatorPoint]

class MovingAverageConvergenceDivergenceEngine:
    @classmethod
    def calculate(cls, data: MovingAverageConvergenceDivergenceInputData) -> MovingAverageConvergenceDivergenceResult:
        ...
        series: List[MovingAverageConvergenceDivergenceIndicatorPoint] = []
        for i in range(n):
            ...
            series.append(MovingAverageConvergenceDivergenceIndicatorPoint(
                index=i,
        ...
        return MovingAverageConvergenceDivergenceResult(
            current_value=curr,
