...
class KaufmanAdaptiveMovingAverageKamaInputData(BaseModel):
...
class KaufmanAdaptiveMovingAverageKamaIndicatorPoint(BaseModel):
    index: int
    primary_value: float
    signal_line: float
    upper_bound: float
...
class KaufmanAdaptiveMovingAverageKamaResult(BaseModel):
    indicator_title: str = "Perry Kaufman Adaptive Moving Average (KAMA)"
    current_value: float
    signal_verdict: str
    is_divergence_detected: bool
    calculated_series: List[KaufmanAdaptiveMovingAverageKamaIndicatorPoint]

class KaufmanAdaptiveMovingAverageKamaEngine:
    @classmethod
    def calculate(cls, data: KaufmanAdaptiveMovingAverageKamaInputData) -> KaufmanAdaptiveMovingAverageKamaResult:
        ...
        series: List[KaufmanAdaptiveMovingAverageKamaIndicatorPoint] = []
        for i in range(n):
            ...
            series.append(KaufmanAdaptiveMovingAverageKamaIndicatorPoint(
                index=i,
        ...
        return KaufmanAdaptiveMovingAverageKamaResult(
            current_value=curr,
