"""
Supertrend Dynamic Trailing Stop-Loss Engine
...
class SupertrendTrailingVolatilityInputData(BaseModel):
...
class SupertrendTrailingVolatilityIndicatorPoint(BaseModel):
    index: int
    primary_value: float
    signal_line: float
    upper_bound: float
...
class SupertrendTrailingVolatilityResult(BaseModel):
    indicator_title: str = "Supertrend Dynamic Trailing Stop-Loss Engine"
    current_value: float
    signal_verdict: str
    is_divergence_detected: bool
    calculated_series: List[SupertrendTrailingVolatilityIndicatorPoint]

class SupertrendTrailingVolatilityEngine:
    @classmethod
    def calculate(cls, data: SupertrendTrailingVolatilityInputData) -> SupertrendTrailingVolatilityResult:
        ...
        series: List[SupertrendTrailingVolatilityIndicatorPoint] = []
        for i in range(n):
            ...
            series.append(SupertrendTrailingVolatilityIndicatorPoint(
                index=i,
        ...
        return SupertrendTrailingVolatilityResult(
            current_value=curr,
