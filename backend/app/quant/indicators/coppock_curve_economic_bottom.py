"""
Edwin Coppock Long-Term Economic Bottom Indicator
...
class CoppockCurveEconomicBottomInputData(BaseModel):
...
class CoppockCurveEconomicBottomIndicatorPoint(BaseModel):
    index: int
    primary_value: float
    signal_line: float
    upper_bound: float
...
class CoppockCurveEconomicBottomResult(BaseModel):
    indicator_title: str = "Edwin Coppock Long-Term Economic Bottom Indicator"
    current_value: float
    signal_verdict: str
    is_divergence_detected: bool
    calculated_series: List[CoppockCurveEconomicBottomIndicatorPoint]

class CoppockCurveEconomicBottomEngine:
    @classmethod
    def calculate(cls, data: CoppockCurveEconomicBottomInputData) -> CoppockCurveEconomicBottomResult:
        ...
        series: List[CoppockCurveEconomicBottomIndicatorPoint] = []
        for i in range(n):
            ...
            series.append(CoppockCurveEconomicBottomIndicatorPoint(
                index=i,
        ...
        return CoppockCurveEconomicBottomResult(
            current_value=curr,
