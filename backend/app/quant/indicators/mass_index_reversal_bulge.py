"""
Donald Dorsey Mass Index Volatility Reversal Bulge
...
class MassIndexReversalBulgeInputData(BaseModel):
...
class MassIndexReversalBulgeIndicatorPoint(BaseModel):
    index: int
    primary_value: float
    signal_line: float
    upper_bound: float
...
class MassIndexReversalBulgeResult(BaseModel):
    indicator_title: str = "Donald Dorsey Mass Index Volatility Reversal Bulge"
    current_value: float
    signal_verdict: str
    is_divergence_detected: bool
    calculated_series: List[MassIndexReversalBulgeIndicatorPoint]

class MassIndexReversalBulgeEngine:
    @classmethod
    def calculate(cls, data: MassIndexReversalBulgeInputData) -> MassIndexReversalBulgeResult:
        ...
        series: List[MassIndexReversalBulgeIndicatorPoint] = []
        for i in range(n):
            ...
            series.append(MassIndexReversalBulgeIndicatorPoint(
                index=i,
        ...
        return MassIndexReversalBulgeResult(
            current_value=curr,
