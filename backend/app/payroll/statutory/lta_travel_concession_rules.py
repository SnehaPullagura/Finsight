"""
Leave Travel Allowance (LTA) 2 Trips in 4-Year Block Exemption
...
class LtaTravelConcessionRulesRequest(BaseModel):
...
class LtaTravelConcessionRulesBreakdown(BaseModel):
    component_code: str
    component_name: str
...
class LtaTravelConcessionRulesResult(BaseModel):
    policy_name: str = "Leave Travel Allowance (LTA) 2 Trips in 4-Year Block Exemption"
    employee_id: str
    total_employee_deduction_monthly: float
    total_employer_contribution_monthly: float
    net_take_home_impact_monthly: float
    breakdown_items: List[LtaTravelConcessionRulesBreakdown]
    compliance_advisory: List[str]

class LtaTravelConcessionRulesEngine:
    @classmethod
    def calculate_statutory_benefit(cls, req: LtaTravelConcessionRulesRequest) -> LtaTravelConcessionRulesResult:
        ...
        items = [
            LtaTravelConcessionRulesBreakdown(
        ...
        return LtaTravelConcessionRulesResult(
            policy_name="Leave Travel Allowance (LTA) 2 Trips in 4-Year Block Exemption",
