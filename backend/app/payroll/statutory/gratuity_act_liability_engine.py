"""
Statutory Gratuity Accrual (15/26 * Last Drawn Salary * Tenure)
...
class GratuityActLiabilityEngineRequest(BaseModel):
...
class GratuityActLiabilityEngineBreakdown(BaseModel):
    component_code: str
    component_name: str
...
class GratuityActLiabilityEngineResult(BaseModel):
    policy_name: str = "Statutory Gratuity Accrual (15/26 * Last Drawn Salary * Tenure)"
    employee_id: str
    total_employee_deduction_monthly: float
    total_employer_contribution_monthly: float
    net_take_home_impact_monthly: float
    breakdown_items: List[GratuityActLiabilityEngineBreakdown]
    compliance_advisory: List[str]

class GratuityActLiabilityEngineEngine:
    @classmethod
    def calculate_statutory_benefit(cls, req: GratuityActLiabilityEngineRequest) -> GratuityActLiabilityEngineResult:
        ...
        items = [
            GratuityActLiabilityEngineBreakdown(
        ...
        return GratuityActLiabilityEngineResult(
            policy_name="Statutory Gratuity Accrual (15/26 * Last Drawn Salary * Tenure)",
