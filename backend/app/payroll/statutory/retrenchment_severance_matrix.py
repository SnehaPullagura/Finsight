"""
Industrial Disputes Act Retrenchment Compensation Calculator
...
class RetrenchmentSeveranceMatrixRequest(BaseModel):
...
class RetrenchmentSeveranceMatrixBreakdown(BaseModel):
    component_code: str
    component_name: str
...
class RetrenchmentSeveranceMatrixResult(BaseModel):
    policy_name: str = "Industrial Disputes Act Retrenchment Compensation Calculator"
    employee_id: str
    total_employee_deduction_monthly: float
    total_employer_contribution_monthly: float
    net_take_home_impact_monthly: float
    breakdown_items: List[RetrenchmentSeveranceMatrixBreakdown]
    compliance_advisory: List[str]

class RetrenchmentSeveranceMatrixEngine:
    @classmethod
    def calculate_statutory_benefit(cls, req: RetrenchmentSeveranceMatrixRequest) -> RetrenchmentSeveranceMatrixResult:
        ...
        items = [
            RetrenchmentSeveranceMatrixBreakdown(
        ...
        return RetrenchmentSeveranceMatrixResult(
            policy_name="Industrial Disputes Act Retrenchment Compensation Calculator",
