"""
Payment of Bonus Act 1965 Allocable Surplus (8.33% to 20%)
...
class StatutoryBonusActEngineRequest(BaseModel):
...
class StatutoryBonusActEngineBreakdown(BaseModel):
    component_code: str
    component_name: str
...
class StatutoryBonusActEngineResult(BaseModel):
    policy_name: str = "Payment of Bonus Act 1965 Allocable Surplus (8.33% to 20%)"
    employee_id: str
    total_employee_deduction_monthly: float
    total_employer_contribution_monthly: float
    net_take_home_impact_monthly: float
    breakdown_items: List[StatutoryBonusActEngineBreakdown]
    compliance_advisory: List[str]

class StatutoryBonusActEngineEngine:
    @classmethod
    def calculate_statutory_benefit(cls, req: StatutoryBonusActEngineRequest) -> StatutoryBonusActEngineResult:
        ...
        items = [
            StatutoryBonusActEngineBreakdown(
        ...
        return StatutoryBonusActEngineResult(
            policy_name="Payment of Bonus Act 1965 Allocable Surplus (8.33% to 20%)",
