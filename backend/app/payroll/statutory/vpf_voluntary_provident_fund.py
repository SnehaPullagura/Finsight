"""
VPF Additional Contribution & Section 10(11) Interest Tax Engine
...
class VpfVoluntaryProvidentFundRequest(BaseModel):
...
class VpfVoluntaryProvidentFundBreakdown(BaseModel):
    component_code: str
    component_name: str
...
class VpfVoluntaryProvidentFundResult(BaseModel):
    policy_name: str = "VPF Additional Contribution & Section 10(11) Interest Tax Engine"
    employee_id: str
    total_employee_deduction_monthly: float
    total_employer_contribution_monthly: float
    net_take_home_impact_monthly: float
    breakdown_items: List[VpfVoluntaryProvidentFundBreakdown]
    compliance_advisory: List[str]

class VpfVoluntaryProvidentFundEngine:
    @classmethod
    def calculate_statutory_benefit(cls, req: VpfVoluntaryProvidentFundRequest) -> VpfVoluntaryProvidentFundResult:
        ...
        items = [
            VpfVoluntaryProvidentFundBreakdown(
        ...
        return VpfVoluntaryProvidentFundResult(
            policy_name="VPF Additional Contribution & Section 10(11) Interest Tax Engine",
