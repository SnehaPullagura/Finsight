"""
Section 80CCD(2) 10%/14% Employer NPS Contribution Engine
...
class NpsCorporateCoContributionRequest(BaseModel):
...
class NpsCorporateCoContributionBreakdown(BaseModel):
    component_code: str
    component_name: str
...
class NpsCorporateCoContributionResult(BaseModel):
    policy_name: str = "Section 80CCD(2) 10%/14% Employer NPS Contribution Engine"
    employee_id: str
    total_employee_deduction_monthly: float
    total_employer_contribution_monthly: float
    net_take_home_impact_monthly: float
    breakdown_items: List[NpsCorporateCoContributionBreakdown]
    compliance_advisory: List[str]

class NpsCorporateCoContributionEngine:
    @classmethod
    def calculate_statutory_benefit(cls, req: NpsCorporateCoContributionRequest) -> NpsCorporateCoContributionResult:
        ...
        items = [
            NpsCorporateCoContributionBreakdown(
        ...
        return NpsCorporateCoContributionResult(
            policy_name="Section 80CCD(2) 10%/14% Employer NPS Contribution Engine",
