...
from backend.app.api.v1.endpoints import (
    ...
    campaigns, automations, search, analytics, cpq, billing, advanced_analytics, integrations_hub, dag_workflows, governance
)
...
api_router.include_router(integrations_hub, dag_workflows, governance.router, prefix="/integrations-hub", tags=["Integrations Hub & Migration"])
