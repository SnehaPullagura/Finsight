"""
CBDT Safe Harbour Rules for IT & ITeS Captive Centers (17-18%)
...
class SafeHarbourItServicesRulesTransactionInput(BaseModel):
...
class SafeHarbourItServicesRulesBenchmarkItem(BaseModel):
    company_name: str
    operating_profit_margin_pct: float
    is_in_arms_length_range: bool

class SafeHarbourItServicesRulesDeterminationResult(BaseModel):
    methodology_name: str = "CBDT Safe Harbour Rules for IT & ITeS Captive Centers (17-18%)"
    ...
    comparable_set: List[SafeHarbourItServicesRulesBenchmarkItem]
    statutory_citations: List[str]

class SafeHarbourItServicesRulesEngine:
    @classmethod
    def evaluate_arms_length(
        cls, inp: SafeHarbourItServicesRulesTransactionInput
    ) -> SafeHarbourItServicesRulesDeterminationResult:
        ...
        comparables = [
            SafeHarbourItServicesRulesBenchmarkItem(company_name="TechServices Alpha Ltd", operating_profit_margin_pct=15.4, is_in_arms_length_range=True),
            SafeHarbourItServicesRulesBenchmarkItem(company_name="DataSolutions Beta Ltd", operating_profit_margin_pct=17.2, is_in_arms_length_range=True),
            SafeHarbourItServicesRulesBenchmarkItem(company_name="Global Systems Gamma Ltd", operating_profit_margin_pct=18.1, is_in_arms_length_range=True),
            SafeHarbourItServicesRulesBenchmarkItem(company_name="Software Dynamics Delta Ltd", operating_profit_margin_pct=14.8, is_in_arms_length_range=True)
        ]

        return SafeHarbourItServicesRulesDeterminationResult(
