"""
Australia - India Double Tax Avoidance Agreement (Offshore Services Taxation)
FinSight International Tax & Cross-Border Wealth Compliance.
"""
from typing import List, Dict, Optional
from pydantic import BaseModel, Field

class AustraliaIndiaDtaaReliefRequest(BaseModel):
    resident_country: str = "India"
    source_country: str = "AUSTRALIA"
...
class AustraliaIndiaDtaaReliefResult(BaseModel):
    treaty_title: str = "Australia - India Double Tax Avoidance Agreement (Offshore Services Taxation)"
...
class AustraliaIndiaDtaaEngine:
    TREATY_RATES = {
        "DIVIDENDS": 10.0,
        "INTEREST": 10.0,
        "ROYALTIES": 15.0,
    ...
    @classmethod
    def compute_foreign_tax_credit(cls, req: AustraliaIndiaDtaaReliefRequest) -> AustraliaIndiaDtaaReliefResult:
        ...
        notes = [
            f"Under the Australia - India Double Tax Avoidance Agreement (Offshore Services Taxation), maximum source withholding is capped at {eff_rate:.1f}%.",
        ...
        return AustraliaIndiaDtaaReliefResult(
