"""
Japan - India Comprehensive Tax Treaty (Withholding Tax Reductions)
FinSight International Tax & Cross-Border Wealth Compliance.
"""
from typing import List, Dict, Optional
from pydantic import BaseModel, Field

class JapanIndiaDtaaReliefRequest(BaseModel):
...
class JapanIndiaDtaaReliefResult(BaseModel):
    treaty_title: str = "Japan - India Comprehensive Tax Treaty (Withholding Tax Reductions)"
...
class JapanIndiaDtaaEngine:
    ...
    @classmethod
    def compute_foreign_tax_credit(cls, req: JapanIndiaDtaaReliefRequest) -> JapanIndiaDtaaReliefResult:
        ...
        notes = [
            f"Under the Japan - India Comprehensive Tax Treaty (Withholding Tax Reductions), maximum source withholding is capped at {eff_rate:.1f}%.",
        ...
        return JapanIndiaDtaaReliefResult(
