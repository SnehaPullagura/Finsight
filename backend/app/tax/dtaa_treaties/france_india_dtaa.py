"""
France - India Double Taxation Avoidance Convention
FinSight International Tax & Cross-Border Wealth Compliance.
"""
from typing import List, Dict, Optional
from pydantic import BaseModel, Field

class FranceIndiaDtaaReliefRequest(BaseModel):
...
class FranceIndiaDtaaReliefResult(BaseModel):
    treaty_title: str = "France - India Double Taxation Avoidance Convention"
...
class FranceIndiaDtaaEngine:
    ...
    @classmethod
    def compute_foreign_tax_credit(cls, req: FranceIndiaDtaaReliefRequest) -> FranceIndiaDtaaReliefResult:
        ...
        notes = [
            f"Under the France - India Double Taxation Avoidance Convention, maximum source withholding is capped at {eff_rate:.1f}%.",
        ...
        return FranceIndiaDtaaReliefResult(
