"""
Hong Kong - India Comprehensive Avoidance of Double Taxation Agreement
FinSight International Tax & Cross-Border Wealth Compliance.
"""
from typing import List, Dict, Optional
from pydantic import BaseModel, Field

class HongkongIndiaDtaaReliefRequest(BaseModel):
    resident_country: str = "India"
    source_country: str = "HONGKONG"
...
class HongkongIndiaDtaaReliefResult(BaseModel):
    treaty_title: str = "Hong Kong - India Comprehensive Avoidance of Double Taxation Agreement"
...
class HongkongIndiaDtaaEngine:
    ...
    @classmethod
    def compute_foreign_tax_credit(cls, req: HongkongIndiaDtaaReliefRequest) -> HongkongIndiaDtaaReliefResult:
        ...
        notes = [
            f"Under the Hong Kong - India Comprehensive Avoidance of Double Taxation Agreement, maximum source withholding is capped at {eff_rate:.1f}%.",
        ...
        return HongkongIndiaDtaaReliefResult(
