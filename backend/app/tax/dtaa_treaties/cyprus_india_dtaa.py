"""
Cyprus - India Tax Treaty (Source-based Capital Gains Taxation)
FinSight International Tax & Cross-Border Wealth Compliance.
"""
from typing import List, Dict, Optional
from pydantic import BaseModel, Field

class CyprusIndiaDtaaReliefRequest(BaseModel):
    resident_country: str = "India"
    source_country: str = "CYPRUS"
...
class CyprusIndiaDtaaReliefResult(BaseModel):
    treaty_title: str = "Cyprus - India Tax Treaty (Source-based Capital Gains Taxation)"
...
class CyprusIndiaDtaaEngine:
    ...
    @classmethod
    def compute_foreign_tax_credit(cls, req: CyprusIndiaDtaaReliefRequest) -> CyprusIndiaDtaaReliefResult:
        ...
        notes = [
            f"Under the Cyprus - India Tax Treaty (Source-based Capital Gains Taxation), maximum source withholding is capped at {eff_rate:.1f}%.",
        ...
        return CyprusIndiaDtaaReliefResult(
