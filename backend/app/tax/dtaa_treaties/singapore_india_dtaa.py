"""
Singapore - India Tax Treaty & Protocol (Limitation of Benefits Article 24A)
FinSight International Tax & Cross-Border Wealth Compliance.
"""
from typing import List, Dict, Optional
from pydantic import BaseModel, Field

class SingaporeIndiaDtaaReliefRequest(BaseModel):
    resident_country: str = "India"
    source_country: str = "SINGAPORE"
...
class SingaporeIndiaDtaaReliefResult(BaseModel):
    treaty_title: str = "Singapore - India Tax Treaty & Protocol (Limitation of Benefits Article 24A)"
...
class SingaporeIndiaDtaaEngine:
    TREATY_RATES = {
        "DIVIDENDS": 10.0,
        "INTEREST": 10.0,
        "ROYALTIES": 15.0,
    ...
    @classmethod
    def compute_foreign_tax_credit(cls, req: SingaporeIndiaDtaaReliefRequest) -> SingaporeIndiaDtaaReliefResult:
        ...
        notes = [
            f"Under the Singapore - India Tax Treaty & Protocol (Limitation of Benefits Article 24A), maximum source withholding is capped at {eff_rate:.1f}%.",
        ...
        return SingaporeIndiaDtaaReliefResult(
