"""
Germany - India Double Tax Avoidance Convention (Article 7 PE Rules)
FinSight International Tax & Cross-Border Wealth Compliance.
"""
from typing import List, Dict, Optional
from pydantic import BaseModel, Field

class GermanyIndiaDtaaReliefRequest(BaseModel):
    resident_country: str = "India"
    source_country: str = "GERMANY"
...
class GermanyIndiaDtaaReliefResult(BaseModel):
    treaty_title: str = "Germany - India Double Tax Avoidance Convention (Article 7 PE Rules)"
...
class GermanyIndiaDtaaEngine:
    ...
    @classmethod
    def compute_foreign_tax_credit(cls, req: GermanyIndiaDtaaReliefRequest) -> GermanyIndiaDtaaReliefResult:
        ...
        notes = [
            f"Under the Germany - India Double Tax Avoidance Convention (Article 7 PE Rules), maximum source withholding is capped at {eff_rate:.1f}%.",
        ...
        return GermanyIndiaDtaaReliefResult(
