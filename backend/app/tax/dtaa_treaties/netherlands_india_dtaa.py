"""
Netherlands - India Double Tax Treaty (MFN Clause & Participation Exemption)
FinSight International Tax & Cross-Border Wealth Compliance.
"""
from typing import List, Dict, Optional
from pydantic import BaseModel, Field

class NetherlandsIndiaDtaaReliefRequest(BaseModel):
    resident_country: str = "India"
    source_country: str = "NETHERLANDS"
...
class NetherlandsIndiaDtaaReliefResult(BaseModel):
    treaty_title: str = "Netherlands - India Double Tax Treaty (MFN Clause & Participation Exemption)"
...
class NetherlandsIndiaDtaaEngine:
    TREATY_RATES = {
        "DIVIDENDS": 10.0,
        "INTEREST": 10.0,
        "ROYALTIES": 15.0,
    ...
    @classmethod
    def compute_foreign_tax_credit(cls, req: NetherlandsIndiaDtaaReliefRequest) -> NetherlandsIndiaDtaaReliefResult:
        ...
        notes = [
            f"Under the Netherlands - India Double Tax Treaty (MFN Clause & Participation Exemption), maximum source withholding is capped at {eff_rate:.1f}%.",
        ...
        return NetherlandsIndiaDtaaReliefResult(
