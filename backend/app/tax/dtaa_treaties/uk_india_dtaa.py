"""
United Kingdom - India Double Taxation Treaty (Article 13 Capital Gains & Dividends)
FinSight International Tax & Cross-Border Wealth Compliance.
"""
from typing import List, Dict, Optional
from pydantic import BaseModel, Field

class UkIndiaDtaaReliefRequest(BaseModel):
...
class UkIndiaDtaaReliefResult(BaseModel):
    treaty_title: str = "United Kingdom - India Double Taxation Treaty (Article 13 Capital Gains & Dividends)"
...
class UkIndiaDtaaEngine:
    ...
    @classmethod
    def compute_foreign_tax_credit(cls, req: UkIndiaDtaaReliefRequest) -> UkIndiaDtaaReliefResult:
        ...
        notes = [
            f"Under the United Kingdom - India Double Taxation Treaty (Article 13 Capital Gains & Dividends), maximum source withholding is capped at {eff_rate:.1f}%.",
        ...
        return UkIndiaDtaaReliefResult(
