"""
Switzerland - India Tax Treaty (Automatic Exchange of Information AEOI)
FinSight International Tax & Cross-Border Wealth Compliance.
"""
from typing import List, Dict, Optional
from pydantic import BaseModel, Field

class SwitzerlandIndiaDtaaReliefRequest(BaseModel):
    resident_country: str = "India"
    source_country: str = "SWITZERLAND"
...
class SwitzerlandIndiaDtaaReliefResult(BaseModel):
    treaty_title: str = "Switzerland - India Tax Treaty (Automatic Exchange of Information AEOI)"
...
class SwitzerlandIndiaDtaaEngine:
    TREATY_RATES = {
        "DIVIDENDS": 10.0,
        "INTEREST": 10.0,
        "ROYALTIES": 15.0,
    ...
    @classmethod
    def compute_foreign_tax_credit(cls, req: SwitzerlandIndiaDtaaReliefRequest) -> SwitzerlandIndiaDtaaReliefResult:
        ...
        notes = [
            f"Under the Switzerland - India Tax Treaty (Automatic Exchange of Information AEOI), maximum source withholding is capped at {eff_rate:.1f}%.",
        ...
        return SwitzerlandIndiaDtaaReliefResult(
