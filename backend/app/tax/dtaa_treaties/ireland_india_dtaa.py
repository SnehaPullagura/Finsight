"""
Ireland - India Tax Treaty (Intellectual Property & Software Royalties)
FinSight International Tax & Cross-Border Wealth Compliance.
"""
from typing import List, Dict, Optional
from pydantic import BaseModel, Field

class IrelandIndiaDtaaReliefRequest(BaseModel):
    resident_country: str = "India"
    source_country: str = "IRELAND"
...
class IrelandIndiaDtaaReliefResult(BaseModel):
    treaty_title: str = "Ireland - India Tax Treaty (Intellectual Property & Software Royalties)"
...
class IrelandIndiaDtaaEngine:
    ...
    @classmethod
    def compute_foreign_tax_credit(cls, req: IrelandIndiaDtaaReliefRequest) -> IrelandIndiaDtaaReliefResult:
        ...
        notes = [
            f"Under the Ireland - India Tax Treaty (Intellectual Property & Software Royalties), maximum source withholding is capped at {eff_rate:.1f}%.",
        ...
        return IrelandIndiaDtaaReliefResult(
