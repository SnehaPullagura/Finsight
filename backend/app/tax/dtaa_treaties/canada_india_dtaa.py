"""
Canada - India Tax Convention (Non-Resident Pension & Royalty Withholding)
FinSight International Tax & Cross-Border Wealth Compliance.
"""
from typing import List, Dict, Optional
from pydantic import BaseModel, Field

class CanadaIndiaDtaaReliefRequest(BaseModel):
    resident_country: str = "India"
    source_country: str = "CANADA"
...
class CanadaIndiaDtaaReliefResult(BaseModel):
    treaty_title: str = "Canada - India Tax Convention (Non-Resident Pension & Royalty Withholding)"
...
class CanadaIndiaDtaaEngine:
    ...
    @classmethod
    def compute_foreign_tax_credit(cls, req: CanadaIndiaDtaaReliefRequest) -> CanadaIndiaDtaaReliefResult:
        ...
        notes = [
            f"Under the Canada - India Tax Convention (Non-Resident Pension & Royalty Withholding), maximum source withholding is capped at {eff_rate:.1f}%.",
        ...
        return CanadaIndiaDtaaReliefResult(
