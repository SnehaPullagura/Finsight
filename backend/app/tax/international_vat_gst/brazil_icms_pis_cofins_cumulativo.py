"""
Brazil SPED ICMS, ISS, PIS/COFINS Tax Reform Engine
...
class BrazilIcmsPisCofinsCumulativoTaxInvoiceRequest(BaseModel):
...
class BrazilIcmsPisCofinsCumulativoJurisdictionTaxLine(BaseModel):
...
class BrazilIcmsPisCofinsCumulativoTaxDeterminationResult(BaseModel):
    statutory_framework: str = "Brazil SPED ICMS, ISS, PIS/COFINS Tax Reform Engine"
    ...
    place_of_supply: str
    tax_breakdown: List[BrazilIcmsPisCofinsCumulativoJurisdictionTaxLine]
    invoice_legal_annotations: List[str]

class BrazilIcmsPisCofinsCumulativoEngine:
    @classmethod
    def determine_vat(
        cls, req: BrazilIcmsPisCofinsCumulativoTaxInvoiceRequest
    ) -> BrazilIcmsPisCofinsCumulativoTaxDeterminationResult:
        ...
        tax_lines = [
            BrazilIcmsPisCofinsCumulativoJurisdictionTaxLine(
        ...
        return BrazilIcmsPisCofinsCumulativoTaxDeterminationResult(
