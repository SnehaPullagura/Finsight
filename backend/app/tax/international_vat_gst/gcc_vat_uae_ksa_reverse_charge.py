"""
GCC Unified VAT (UAE 5%, KSA 15%) Cross-Border Mechanism
...
class GccVatUaeKsaReverseChargeTaxInvoiceRequest(BaseModel):
...
class GccVatUaeKsaReverseChargeJurisdictionTaxLine(BaseModel):
...
class GccVatUaeKsaReverseChargeTaxDeterminationResult(BaseModel):
    statutory_framework: str = "GCC Unified VAT (UAE 5%, KSA 15%) Cross-Border Mechanism"
    ...
    place_of_supply: str
    tax_breakdown: List[GccVatUaeKsaReverseChargeJurisdictionTaxLine]
    invoice_legal_annotations: List[str]

class GccVatUaeKsaReverseChargeEngine:
    @classmethod
    def determine_vat(
        cls, req: GccVatUaeKsaReverseChargeTaxInvoiceRequest
    ) -> GccVatUaeKsaReverseChargeTaxDeterminationResult:
        ...
        tax_lines = [
            GccVatUaeKsaReverseChargeJurisdictionTaxLine(
        ...
        return GccVatUaeKsaReverseChargeTaxDeterminationResult(
