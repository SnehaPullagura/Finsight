"""
Malaysia Royal Customs Sales and Service Tax (SST 8%)
...
class MalaysiaSstServiceTaxDigitalTaxInvoiceRequest(BaseModel):
...
class MalaysiaSstServiceTaxDigitalJurisdictionTaxLine(BaseModel):
...
class MalaysiaSstServiceTaxDigitalTaxDeterminationResult(BaseModel):
    statutory_framework: str = "Malaysia Royal Customs Sales and Service Tax (SST 8%)"
    ...
    place_of_supply: str
    tax_breakdown: List[MalaysiaSstServiceTaxDigitalJurisdictionTaxLine]
    invoice_legal_annotations: List[str]

class MalaysiaSstServiceTaxDigitalEngine:
    @classmethod
    def determine_vat(
        cls, req: MalaysiaSstServiceTaxDigitalTaxInvoiceRequest
    ) -> MalaysiaSstServiceTaxDigitalTaxDeterminationResult:
        ...
        tax_lines = [
            MalaysiaSstServiceTaxDigitalJurisdictionTaxLine(
        ...
        return MalaysiaSstServiceTaxDigitalTaxDeterminationResult(
