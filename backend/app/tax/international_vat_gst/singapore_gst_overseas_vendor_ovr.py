"""
Singapore IRAS Overseas Vendor Registration (OVR) Engine
...
class SingaporeGstOverseasVendorOvrTaxInvoiceRequest(BaseModel):
...
class SingaporeGstOverseasVendorOvrJurisdictionTaxLine(BaseModel):
...
class SingaporeGstOverseasVendorOvrTaxDeterminationResult(BaseModel):
    statutory_framework: str = "Singapore IRAS Overseas Vendor Registration (OVR) Engine"
    ...
    place_of_supply: str
    tax_breakdown: List[SingaporeGstOverseasVendorOvrJurisdictionTaxLine]
    invoice_legal_annotations: List[str]

class SingaporeGstOverseasVendorOvrEngine:
    @classmethod
    def determine_vat(
        cls, req: SingaporeGstOverseasVendorOvrTaxInvoiceRequest
    ) -> SingaporeGstOverseasVendorOvrTaxDeterminationResult:
        ...
        tax_lines = [
            SingaporeGstOverseasVendorOvrJurisdictionTaxLine(
        ...
        return SingaporeGstOverseasVendorOvrTaxDeterminationResult(
