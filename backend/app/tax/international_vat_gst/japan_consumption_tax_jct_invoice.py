"""
Japan Qualified Invoice System (QIS) JCT Input Tax Credit
...
class JapanConsumptionTaxJctInvoiceTaxInvoiceRequest(BaseModel):
...
class JapanConsumptionTaxJctInvoiceJurisdictionTaxLine(BaseModel):
...
class JapanConsumptionTaxJctInvoiceTaxDeterminationResult(BaseModel):
    statutory_framework: str = "Japan Qualified Invoice System (QIS) JCT Input Tax Credit"
    ...
    place_of_supply: str
    tax_breakdown: List[JapanConsumptionTaxJctInvoiceJurisdictionTaxLine]
    invoice_legal_annotations: List[str]

class JapanConsumptionTaxJctInvoiceEngine:
    @classmethod
    def determine_vat(
        cls, req: JapanConsumptionTaxJctInvoiceTaxInvoiceRequest
    ) -> JapanConsumptionTaxJctInvoiceTaxDeterminationResult:
        ...
        tax_lines = [
            JapanConsumptionTaxJctInvoiceJurisdictionTaxLine(
        ...
        return JapanConsumptionTaxJctInvoiceTaxDeterminationResult(
