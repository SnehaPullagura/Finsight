"""
Saudi ZATCA Phase-2 Fatoora Cryptographic E-Invoicing XML
...
class SaudiZatcaPhase2EinvoicingTaxInvoiceRequest(BaseModel):
...
class SaudiZatcaPhase2EinvoicingJurisdictionTaxLine(BaseModel):
...
class SaudiZatcaPhase2EinvoicingTaxDeterminationResult(BaseModel):
    statutory_framework: str = "Saudi ZATCA Phase-2 Fatoora Cryptographic E-Invoicing XML"
    ...
    place_of_supply: str
    tax_breakdown: List[SaudiZatcaPhase2EinvoicingJurisdictionTaxLine]
    invoice_legal_annotations: List[str]

class SaudiZatcaPhase2EinvoicingEngine:
    @classmethod
    def determine_vat(
        cls, req: SaudiZatcaPhase2EinvoicingTaxInvoiceRequest
    ) -> SaudiZatcaPhase2EinvoicingTaxDeterminationResult:
        ...
        tax_lines = [
            SaudiZatcaPhase2EinvoicingJurisdictionTaxLine(
        ...
        return SaudiZatcaPhase2EinvoicingTaxDeterminationResult(
