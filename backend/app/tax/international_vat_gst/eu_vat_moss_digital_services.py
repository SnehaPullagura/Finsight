"""
EU VAT One-Stop Shop (OSS / IOSS) Digital Services Engine
...
class EuVatMossDigitalServicesTaxInvoiceRequest(BaseModel):
...
class EuVatMossDigitalServicesJurisdictionTaxLine(BaseModel):
...
class EuVatMossDigitalServicesTaxDeterminationResult(BaseModel):
    statutory_framework: str = "EU VAT One-Stop Shop (OSS / IOSS) Digital Services Engine"
    ...
    place_of_supply: str
    tax_breakdown: List[EuVatMossDigitalServicesJurisdictionTaxLine]
    invoice_legal_annotations: List[str]

class EuVatMossDigitalServicesEngine:
    @classmethod
    def determine_vat(
        cls, req: EuVatMossDigitalServicesTaxInvoiceRequest
    ) -> EuVatMossDigitalServicesTaxDeterminationResult:
        ...
        tax_lines = [
            EuVatMossDigitalServicesJurisdictionTaxLine(
        ...
        return EuVatMossDigitalServicesTaxDeterminationResult(
