"""
Australia ATO GST on Low Value Imported Goods (LVIG)
...
class AustraliaGstLowValueImportedTaxInvoiceRequest(BaseModel):
...
class AustraliaGstLowValueImportedJurisdictionTaxLine(BaseModel):
...
class AustraliaGstLowValueImportedTaxDeterminationResult(BaseModel):
    statutory_framework: str = "Australia ATO GST on Low Value Imported Goods (LVIG)"
    ...
    place_of_supply: str
    tax_breakdown: List[AustraliaGstLowValueImportedJurisdictionTaxLine]
    invoice_legal_annotations: List[str]

class AustraliaGstLowValueImportedEngine:
    @classmethod
    def determine_vat(
        cls, req: AustraliaGstLowValueImportedTaxInvoiceRequest
    ) -> AustraliaGstLowValueImportedTaxDeterminationResult:
        ...
        tax_lines = [
            AustraliaGstLowValueImportedJurisdictionTaxLine(
        ...
        return AustraliaGstLowValueImportedTaxDeterminationResult(
