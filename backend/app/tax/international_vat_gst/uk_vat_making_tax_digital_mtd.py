"""
UK HMRC Making Tax Digital (MTD) API VAT Return Compiler
...
class UkVatMakingTaxDigitalMtdTaxInvoiceRequest(BaseModel):
...
class UkVatMakingTaxDigitalMtdJurisdictionTaxLine(BaseModel):
...
class UkVatMakingTaxDigitalMtdTaxDeterminationResult(BaseModel):
    statutory_framework: str = "UK HMRC Making Tax Digital (MTD) API VAT Return Compiler"
    ...
    place_of_supply: str
    tax_breakdown: List[UkVatMakingTaxDigitalMtdJurisdictionTaxLine]
    invoice_legal_annotations: List[str]

class UkVatMakingTaxDigitalMtdEngine:
    @classmethod
    def determine_vat(
        cls, req: UkVatMakingTaxDigitalMtdTaxInvoiceRequest
    ) -> UkVatMakingTaxDigitalMtdTaxDeterminationResult:
        ...
        tax_lines = [
            UkVatMakingTaxDigitalMtdJurisdictionTaxLine(
        ...
        return UkVatMakingTaxDigitalMtdTaxDeterminationResult(
