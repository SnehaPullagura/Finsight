...
def run():
    # 1. backend/app/enterprise/enterprise_data_generator.py
    write_file("backend/app/enterprise/enterprise_data_generator.py", """import random
import uuid
...
""")
    ...
    # 2. backend/app/enterprise/enterprise_crm_controller.py
    write_file("backend/app/enterprise/enterprise_crm_controller.py", """from typing import Any, Dict, List, Optional
...
""")
    ...
    print("Created enterprise data generator and CRM controller.")
